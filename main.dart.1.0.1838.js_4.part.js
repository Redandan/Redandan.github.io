...
e03(d,e){var x=new B.Gm(e,d,A.aV("WebRTCManager"))
x.bRm()
return x},
...
B.Gm.prototype={
Pq(d){return this.dmQ(d)},
dmQ(d){var x=0,w=A.m(y.e),v,u=this
var $async$Pq=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yY(new B.bRS(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$Pq)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Pq,w)},
bRm(){var x=this,w=x.a
x.y=w.gdd_().e7(new B.bRI(x),new B.bRJ(x))
x.z=w.gdt9().e7(new B.bRK(x),new B.bRL(x))
x.Q=w.gdmI().e7(new B.bRM(x),new B.bRN(x))
x.as=w.gcew().e7(new B.bRO(x),new B.bRP(x))},
UP(d){return this.ceE(d)},
ceE(d){var x=0,w=A.m(y.e),v,u=this
var $async$UP=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yY(new B.bRT(u,d),"startAudioCall","Failed to start audio call",y.e),$async$UP)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$UP,w)},
qc(d){return this.dbB(d)},
dbB(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qc=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yY(new B.bRQ(u,d),"answerCall",t,y.e),$async$qc)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yY(new B.bRR(v),"endCall","Failed to end call",y.p),$async$t3)
case 2:return A.k(null,w)}})
return A.l($async$t3,w)},
bEY(){return D.dm2(new B.bRU(this),"toggleAudio","Failed to switch audio")},
cdl(d){this.e=d},
cdj(d){this.f=d},
cdk(d){var x=null,w=this.c
...
return!1}return x.a.bEY()},
$S:35};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.Gm,A.V)
w(A.h6,[B.bRS,B.bRT,B.bRQ,B.bRR,B.bRU])
w(A.fg,[B.bRI,B.bRJ,B.bRK,B.bRL,B.bRM,B.bRN,B.bRO,B.bRP])})()
A.fR(b.typeUniverse,JSON.parse('{"Gm":{"a60":[],"ay9":[]}}'))
var y={p:A.au("bn"),e:A.au("K"),b:A.au("@"),f:A.au("~")}};
(a=>{a["9YhzBQzEObxdoknBpUQw+jLn0y8="]=a.current})($__dart_deferred_initializers__);