...
e7r(d,e){var x=new B.GW(e,d,A.aY("WebRTCManager"))
x.bVd()
return x},
...
return A.c(D.z9(new B.bVa(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WZ)
case 3:v=f
x=1
break
...
x.y=w.gdix().ee(new B.bV0(x),new B.bV1(x))
x.z=w.gdyQ().ee(new B.bV2(x),new B.bV3(x))
x.Q=w.gdsi().ee(new B.bV4(x),new B.bV5(x))
x.as=w.gciX().ee(new B.bV6(x),new B.bV7(x))},
abg(d){return this.cj4(d)},
cj4(d){var x=0,w=A.m(y.e),v,u=this
var $async$abg=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z9(new B.bVb(u,d),"startAudioCall","Failed to start audio call",y.e),$async$abg)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
x=3
return A.c(D.z9(new B.bV8(u,d),"answerCall",t,y.e),$async$ql)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z9(new B.bV9(v),"endCall","Failed to end call",y.p),$async$tu)
case 2:return A.k(null,w)}})
return A.l($async$tu,w)},
bIH(){return D.ds2(new B.bVc(this),"toggleAudio","Failed to switch audio")},
chL(d){this.e=d},
chJ(d){this.f=d},
...
x(B.GW,A.V)
w(A.hd,[B.bVa,B.bVb,B.bV8,B.bV9,B.bVc])
w(A.fi,[B.bV0,B.bV1,B.bV2,B.bV3,B.bV4,B.bV5,B.bV6,B.bV7])})()
A.fU(b.typeUniverse,JSON.parse('{"GW":{"a76":[],"azB":[]}}'))
var y={p:A.au("bo"),e:A.au("Q"),b:A.au("@"),f:A.au("~")}};
(a=>{a["pEciN9RjLyiAvLe+lNJwEBenQ6U="]=a.current})($__dart_deferred_initializers__);