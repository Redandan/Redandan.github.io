...
dXq(d,e){var x=new B.G5(e,d,A.aU("WebRTCManager"))
x.bO7()
return x},
...
B.G5.prototype={
OQ(d){return this.diF(d)},
diF(d){var x=0,w=A.m(y.e),v,u=this
var $async$OQ=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yK(new B.bQw(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$OQ)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$OQ,w)},
bO7(){var x=this,w=x.a
x.y=w.gd9_().e5(new B.bQm(x),new B.bQn(x))
x.z=w.gdoJ().e5(new B.bQo(x),new B.bQp(x))
x.Q=w.gdix().e5(new B.bQq(x),new B.bQr(x))
x.as=w.gcba().e5(new B.bQs(x),new B.bQt(x))},
Ua(d){return this.cbi(d)},
cbi(d){var x=0,w=A.m(y.e),v,u=this
var $async$Ua=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yK(new B.bQx(u,d),"startAudioCall","Failed to start audio call",y.e),$async$Ua)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Ua,w)},
q9(d){return this.d7H(d)},
d7H(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$q9=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yK(new B.bQu(u,d),"answerCall",t,y.e),$async$q9)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yK(new B.bQv(v),"endCall","Failed to end call",y.p),$async$t_)
case 2:return A.k(null,w)}})
return A.l($async$t_,w)},
bBP(){return D.diM(new B.bQy(this),"toggleAudio","Failed to switch audio")},
ca_(d){this.e=d},
c9Y(d){this.f=d},
...
c9X(d){this.w=d},
gbyw(){return this.d},
ga49(){return this.a.ga49()},
ga4e(){return this.a.ga4e()},
ga1A(){return this.a.ga1A()},
aqm(){var x=0,w=A.m(y.f),v=this,u,t
var $async$aqm=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.aqm(),$async$$0)
case 5:case 4:s.a.bE4(q)
...
q=q.a
t.k(C.d,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.ga49(),null,null)
x=3
return A.c(q.ajo(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bBP()},
$S:35};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.G5,A.U)
w(A.h4,[B.bQw,B.bQx,B.bQu,B.bQv,B.bQy])
w(A.fe,[B.bQm,B.bQn,B.bQo,B.bQp,B.bQq,B.bQr,B.bQs,B.bQt])})()
A.fP(b.typeUniverse,JSON.parse('{"G5":{"a5_":[],"axg":[]}}'))
var y={p:A.aw("bm"),e:A.aw("K"),b:A.aw("@"),f:A.aw("~")}};
(a=>{a["t6bLrVBq+y1ucuWFtpOJoaAyHbo="]=a.current})($__dart_deferred_initializers__);