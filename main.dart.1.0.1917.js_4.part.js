...
e7q(d,e){var x=new B.GW(e,d,A.aY("WebRTCManager"))
x.bXl()
return x},
...
B.GW.prototype={
XC(d){return this.duy(d)},
duy(d){var x=0,w=A.m(y.e),v,u=this
var $async$XC=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z8(new B.bV9(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$XC)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$XC,w)},
bXl(){var x=this,w=x.a
x.y=w.gdkG().ee(new B.bV_(x),new B.bV0(x))
x.z=w.gdB_().ee(new B.bV1(x),new B.bV2(x))
x.Q=w.gdur().ee(new B.bV3(x),new B.bV4(x))
x.as=w.gcl6().ee(new B.bV5(x),new B.bV6(x))},
ac_(d){return this.cle(d)},
cle(d){var x=0,w=A.m(y.e),v,u=this
var $async$ac_=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z8(new B.bVa(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ac_)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$ac_,w)},
ql(d){return this.djh(d)},
djh(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$ql=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z8(new B.bV7(u,d),"answerCall",t,y.e),$async$ql)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z8(new B.bV8(v),"endCall","Failed to end call",y.p),$async$tv)
case 2:return A.k(null,w)}})
return A.l($async$tv,w)},
bKP(){return D.ds1(new B.bVb(this),"toggleAudio","Failed to switch audio")},
cjV(d){this.e=d},
cjT(d){this.f=d},
cjU(d){var x=null,w=this.c
...
cjS(d){this.w=d},
gbHj(){return this.d},
gaLH(){return this.a.gaLH()},
gaLM(){return this.a.gaLM()},
gaAB(){return this.a.gaAB()},
bj3(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bj3=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bj3(),$async$$0)
case 5:case 4:s.a.bN7(q)
...
q=q.a
t.k(C.h,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.gaLH(),null,null)
x=3
...
return!1}return x.a.bKP()},
$S:30};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GW,A.V)
w(A.hd,[B.bV9,B.bVa,B.bV7,B.bV8,B.bVb])
w(A.fi,[B.bV_,B.bV0,B.bV1,B.bV2,B.bV3,B.bV4,B.bV5,B.bV6])})()
A.fU(b.typeUniverse,JSON.parse('{"GW":{"a77":[],"azC":[]}}'))
var y={p:A.au("bo"),e:A.au("Q"),b:A.au("@"),f:A.au("~")}};
(a=>{a["tiQkSVgSou7lwG3SOp7kDYv1ezQ="]=a.current})($__dart_deferred_initializers__);