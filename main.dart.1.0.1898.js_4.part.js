...
e5_(d,e){var x=new B.GJ(e,d,A.aY("WebRTCManager"))
x.bUk()
return x},
...
B.GJ.prototype={
WL(d){return this.dqX(d)},
dqX(d){var x=0,w=A.m(y.e),v,u=this
var $async$WL=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z2(new B.bUe(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WL)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$WL,w)},
bUk(){var x=this,w=x.a
x.y=w.gdh2().ee(new B.bU4(x),new B.bU5(x))
x.z=w.gdxl().ee(new B.bU6(x),new B.bU7(x))
x.Q=w.gdqQ().ee(new B.bU8(x),new B.bU9(x))
x.as=w.gchV().ee(new B.bUa(x),new B.bUb(x))},
ab3(d){return this.ci2(d)},
ci2(d){var x=0,w=A.m(y.e),v,u=this
var $async$ab3=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z2(new B.bUf(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ab3)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$ab3,w)},
qi(d){return this.dfE(d)},
dfE(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qi=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z2(new B.bUc(u,d),"answerCall",t,y.e),$async$qi)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$qi,w)},
tq(){var x=0,w=A.m(y.f),v=this
var $async$tq=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:x=2
return A.c(D.z2(new B.bUd(v),"endCall","Failed to end call",y.p),$async$tq)
case 2:return A.k(null,w)}})
return A.l($async$tq,w)},
bHO(){return D.dpY(new B.bUg(this),"toggleAudio","Failed to switch audio")},
cgJ(d){this.e=d},
cgH(d){this.f=d},
...
cgG(d){this.w=d},
gbEh(){return this.d},
gaJU(){return this.a.gaJU()},
gaJZ(){return this.a.gaJZ()},
gayv(){return this.a.gayv()},
bgg(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bgg=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bgg(),$async$$0)
case 5:case 4:s.a.bK6(q)
...
q=q.a
t.k(C.h,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.gaJU(),null,null)
x=3
return A.c(q.bbq(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bHO()},
$S:29};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GJ,A.V)
w(A.h9,[B.bUe,B.bUf,B.bUc,B.bUd,B.bUg])
w(A.fi,[B.bU4,B.bU5,B.bU6,B.bU7,B.bU8,B.bU9,B.bUa,B.bUb])})()
A.fU(b.typeUniverse,JSON.parse('{"GJ":{"a6J":[],"az8":[]}}'))
var y={p:A.au("bo"),e:A.au("O"),b:A.au("@"),f:A.au("~")}};
(a=>{a["/wx08SeW3BTIq62aBgYBI69DmMA="]=a.current})($__dart_deferred_initializers__);