...
dWm(d,e){var x=new B.G_(e,d,A.aU("WebRTCManager"))
x.bNW()
return x},
...
B.G_.prototype={
OL(d){return this.dih(d)},
dih(d){var x=0,w=A.m(y.e),v,u=this
var $async$OL=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yI(new B.bPZ(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$OL)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$OL,w)},
bNW(){var x=this,w=x.a
x.y=w.gd8E().e5(new B.bPP(x),new B.bPQ(x))
x.z=w.gdol().e5(new B.bPR(x),new B.bPS(x))
x.Q=w.gdi9().e5(new B.bPT(x),new B.bPU(x))
x.as=w.gcaY().e5(new B.bPV(x),new B.bPW(x))},
U5(d){return this.cb5(d)},
cb5(d){var x=0,w=A.m(y.e),v,u=this
var $async$U5=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yI(new B.bQ_(u,d),"startAudioCall","Failed to start audio call",y.e),$async$U5)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$U5,w)},
q9(d){return this.d7l(d)},
d7l(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$q9=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yI(new B.bPX(u,d),"answerCall",t,y.e),$async$q9)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yI(new B.bPY(v),"endCall","Failed to end call",y.p),$async$t_)
case 2:return A.k(null,w)}})
return A.l($async$t_,w)},
bBD(){return D.dhU(new B.bQ0(this),"toggleAudio","Failed to switch audio")},
c9N(d){this.e=d},
c9L(d){this.f=d},
c9M(d){var x=null,w=this.c
...
ga1t(){return this.a.ga1t()},
aqd(){var x=0,w=A.m(y.f),v=this,u,t
...
x=5
return A.c(s.aqd(),$async$$0)
case 5:case 4:s.a.bDT(q)
...
x=10
return A.c(A.cZ(C.cj,null,y.b),$async$$0)
...
q=q.a
t.k(C.d,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.ga42(),null,null)
x=3
return A.c(q.ajh(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bBD()},
$S:35};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.G_,A.U)
w(A.h4,[B.bPZ,B.bQ_,B.bPX,B.bPY,B.bQ0])
w(A.fd,[B.bPP,B.bPQ,B.bPR,B.bPS,B.bPT,B.bPU,B.bPV,B.bPW])})()
A.fO(b.typeUniverse,JSON.parse('{"G_":{"a4J":[],"awW":[]}}'))
var y={p:A.aw("bm"),e:A.aw("I"),b:A.aw("@"),f:A.aw("~")}};
(a=>{a["3TeKTsiU4WkQPB02s9i2zM8RiSo="]=a.current})($__dart_deferred_initializers__);