...
e0Y(d,e){var x=new B.HE(e,d,A.aX("WebRTCManager"))
x.bXR()
return x},
...
return A.c(D.yO(new B.bUS(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$XD)
case 3:v=f
x=1
break
...
x.y=w.gdla().ed(new B.bUI(x),new B.bUJ(x))
x.z=w.gdBz().ed(new B.bUK(x),new B.bUL(x))
x.Q=w.gduT().ed(new B.bUM(x),new B.bUN(x))
x.as=w.gclE().ed(new B.bUO(x),new B.bUP(x))},
ac2(d){return this.clM(d)},
clM(d){var x=0,w=A.l(y.e),v,u=this
var $async$ac2=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yO(new B.bUT(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ac2)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
...
x=3
return A.c(D.yO(new B.bUQ(u,d),"answerCall",t,y.e),$async$qv)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
...
return A.c(D.yO(new B.bUR(v),"endCall","Failed to end call",y.p),$async$tE)
case 2:return A.j(null,w)}})
return A.k($async$tE,w)},
bLf(){return D.drK(new B.bUU(this),"toggleAudio","Failed to switch audio")},
ckq(d){this.e=d},
cko(d){this.f=d},
...
x(B.HE,A.T)
w(A.he,[B.bUS,B.bUT,B.bUQ,B.bUR,B.bUU])
w(A.ff,[B.bUI,B.bUJ,B.bUK,B.bUL,B.bUM,B.bUN,B.bUO,B.bUP])})()
A.fu(b.typeUniverse,JSON.parse('{"HE":{"a4N":[],"awx":[]}}'))
var y={p:A.au("bn"),e:A.au("N"),b:A.au("@"),f:A.au("~")}};
(a=>{a["oMhVSWNFd/wryLoD76D+h67YI1E="]=a.current})($__dart_deferred_initializers__);