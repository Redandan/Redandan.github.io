...
e_y(d,e){var x=new B.Gk(e,d,A.aU("WebRTCManager"))
x.bQs()
return x},
...
B.Gk.prototype={
Pq(d){return this.dlT(d)},
dlT(d){var x=0,w=A.m(y.e),v,u=this
var $async$Pq=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yW(new B.bRv(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$Pq)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Pq,w)},
bQs(){var x=this,w=x.a
x.y=w.gdc3().e7(new B.bRl(x),new B.bRm(x))
x.z=w.gdsc().e7(new B.bRn(x),new B.bRo(x))
x.Q=w.gdlL().e7(new B.bRp(x),new B.bRq(x))
x.as=w.gcdC().e7(new B.bRr(x),new B.bRs(x))},
Uz(d){return this.cdK(d)},
cdK(d){var x=0,w=A.m(y.e),v,u=this
var $async$Uz=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yW(new B.bRw(u,d),"startAudioCall","Failed to start audio call",y.e),$async$Uz)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Uz,w)},
qd(d){return this.daF(d)},
daF(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qd=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yW(new B.bRt(u,d),"answerCall",t,y.e),$async$qd)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yW(new B.bRu(v),"endCall","Failed to end call",y.p),$async$t4)
case 2:return A.k(null,w)}})
return A.l($async$t4,w)},
bE_(){return D.dlz(new B.bRx(this),"toggleAudio","Failed to switch audio")},
ccr(d){this.e=d},
ccp(d){this.f=d},
ccq(d){var x=null,w=this.c
...
arI(){var x=0,w=A.m(y.f),v=this,u,t
var $async$arI=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.arI(),$async$$0)
case 5:case 4:s.a.bGg(q)
...
x=3
return A.c(q.akJ(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bE_()},
$S:35};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.Gk,A.W)
w(A.fY,[B.bRv,B.bRw,B.bRt,B.bRu,B.bRx])
w(A.fg,[B.bRl,B.bRm,B.bRn,B.bRo,B.bRp,B.bRq,B.bRr,B.bRs])})()
A.fI(b.typeUniverse,JSON.parse('{"Gk":{"a5T":[],"axZ":[]}}'))
var y={p:A.at("bn"),e:A.at("K"),b:A.at("@"),f:A.at("~")}};
(a=>{a["uXkk3qcWFfwXHNYgHgiLrRJEzsM="]=a.current})($__dart_deferred_initializers__);