...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1266: (x0,x1) => x0.removeItem(x1),
      _1267: (x0,x1) => x0.getElementById(x1),
      _1268: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1268(f,arguments.length,x0,x1) }),
      _1269: (x0,x1) => x0.requestVideoFrameCallback(x1),
      _1270: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1271: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1271(f,arguments.length,x0) }),
      _1272: (x0,x1) => x0.requestAnimationFrame(x1),
      _1273: (x0,x1) => x0.cancelVideoFrameCallback(x1),
      _1274: (x0,x1) => x0.cancelAnimationFrame(x1),
      _1275: () => new MediaStream(),
      _1276: x0 => x0.getVideoTracks(),
      _1277: (x0,x1) => x0.addTrack(x1),
      _1278: x0 => x0.getAudioTracks(),
      _1279: (x0,x1) => x0.append(x1),
      _1280: (x0,x1) => x0.removeAttribute(x1),
      _1281: x0 => x0.load(),
      _1282: x0 => x0.remove(),
      _1283: x0 => x0.hasChildNodes(),
      ...
      _1360: (x0,x1) => x0.canShare(x1),
      _1361: (x0,x1) => x0.share(x1),
      _1364: (x0,x1) => ({files: x0,text: x1}),
      _1366: x0 => ({files: x0}),
      _1368: x0 => ({text: x0}),
      _1369: x0 => x0.click(),
      _1372: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1373: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1373(f,arguments.length,x0) }),
      _1374: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1379: (x0,x1) => x0.replaceChildren(x1),
      _1380: (x0,x1) => globalThis.requestNotificationPermission(x0,x1),
      _1381: x0 => x0.decode(),
      ...
      _1391: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1392: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1397: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1418: (x0,x1,x2) => x0.addEventListener(x1,x2),
