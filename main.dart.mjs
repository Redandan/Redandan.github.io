...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1266: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1266(f,arguments.length,x0,x1) }),
      _1267: (x0,x1) => x0.requestVideoFrameCallback(x1),
      _1268: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1269: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1269(f,arguments.length,x0) }),
      _1270: (x0,x1) => x0.requestAnimationFrame(x1),
      _1271: (x0,x1) => x0.cancelVideoFrameCallback(x1),
      _1272: (x0,x1) => x0.cancelAnimationFrame(x1),
      _1273: () => new MediaStream(),
      _1274: x0 => x0.getVideoTracks(),
      _1275: (x0,x1) => x0.addTrack(x1),
      _1276: x0 => x0.getAudioTracks(),
      _1277: (x0,x1) => x0.append(x1),
      _1278: (x0,x1) => x0.removeAttribute(x1),
      _1279: x0 => x0.load(),
      _1280: x0 => x0.remove(),
      _1281: x0 => x0.hasChildNodes(),
      ...
      _1377: (x0,x1) => x0.replaceChildren(x1),
      _1378: (x0,x1) => globalThis.requestNotificationPermission(x0,x1),
      _1379: x0 => x0.decode(),
      ...
      _1389: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1390: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1395: (x0,x1) => x0.getItem(x1),
      _1396: (x0,x1) => x0.removeItem(x1),
