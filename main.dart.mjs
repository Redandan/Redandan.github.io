...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1379: (x0,x1) => globalThis.requestNotificationPermission(x0,x1),
      _1380: x0 => x0.decode(),
      ...
      _1390: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1391: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
