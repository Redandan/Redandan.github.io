...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1571: x0 => x0.close(),
      _1573: (x0,x1) => x0.createOffer(x1),
      _1574: (x0,x1) => x0.createAnswer(x1),
      _1577: (x0,x1) => ({type: x0,sdp: x1}),
      _1578: (x0,x1) => x0.setLocalDescription(x1),
      _1579: (x0,x1) => ({type: x0,sdp: x1}),
      _1580: (x0,x1) => x0.setRemoteDescription(x1),
      _1581: (x0,x1,x2) => ({candidate: x0,sdpMid: x1,sdpMLineIndex: x2}),
      _1582: (x0,x1) => x0.addIceCandidate(x1),
      _1590: x0 => x0.restartIce(),
      _1592: (x0,x1,x2) => x0.addTrack(x1,x2),
      _1602: x0 => new RTCPeerConnection(x0),
      _1611: (x0,x1) => ({video: x0,audio: x1}),
