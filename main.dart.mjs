...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1285: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      ...
      _1288: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1292: (x0,x1) => x0.querySelector(x1),
      ...
      _1458: Object.is,
      _1459: o => o instanceof Array,
      _1460: (a, i) => a.push(i),
      _1463: (a, l) => a.length = l,
      _1464: a => a.pop(),
      _1465: (a, i) => a.splice(i, 1),
      _1466: (a, s) => a.join(s),
      _1467: (a, s, e) => a.slice(s, e),
      _1469: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1470: a => a.length,
      ...
      _1476: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1478: o => o instanceof Uint8Array,
      _1479: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1480: o => o instanceof Int8Array,
      _1481: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1482: o => o instanceof Uint8ClampedArray,
      _1483: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1484: o => o instanceof Uint16Array,
      _1485: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1486: o => o instanceof Int16Array,
      _1487: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1488: o => o instanceof Uint32Array,
      _1489: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1490: o => o instanceof Int32Array,
      _1491: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1493: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1494: o => o instanceof Float32Array,
      _1495: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1496: o => o instanceof Float64Array,
      _1497: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1498: (t, s) => t.set(s),
      _1499: l => new DataView(new ArrayBuffer(l)),
      _1500: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1502: o => o.buffer,
      _1503: o => o.byteOffset,
      _1504: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1505: (b, o) => new DataView(b, o),
      _1506: (b, o, l) => new DataView(b, o, l),
      _1507: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1508: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1509: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1510: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1511: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1512: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1513: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1514: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1515: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1516: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1517: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1518: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1521: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1522: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1523: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1524: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1525: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1526: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1539: (ms, c) =>
      ...
      _1544: () => Date.now(),
      _1549: o => Object.keys(o),
      _1560: x0 => new RTCPeerConnection(x0),
      ...
      _1579: (x0,x1,x2) => ({candidate: x0,sdpMid: x1,sdpMLineIndex: x2}),
      _1580: (x0,x1) => x0.addIceCandidate(x1),
      _1590: (x0,x1,x2) => x0.addTrack(x1,x2),
      _1608: (x0,x1) => x0.getUserMedia(x1),
      _1609: (x0,x1) => ({video: x0,audio: x1}),
      ...
      _1659: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1659(f,arguments.length,x0,x1,x2) }),
      _1660: (x0,x1) => x0.forEach(x1),
      _1661: x0 => x0.getReader(),
      _1662: x0 => x0.read(),
      _1663: x0 => x0.cancel(),
      _4338: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4338(f,arguments.length,x0) }),
      _4339: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4339(f,arguments.length,x0) }),
      _4352: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _4354: (s, m) => {
        try {
      ...
      _4355: (x0,x1) => x0.exec(x1),
      _4356: (x0,x1) => x0.test(x1),
      _4357: x0 => x0.pop(),
      _4359: o => o === undefined,
      _4361: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _4363: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _4364: o => o instanceof RegExp,
      _4365: (l, r) => l === r,
      _4366: o => o,
      _4367: o => o,
      _4368: o => o,
      ...
      _4370: o => o.length,
      _4372: (o, i) => o[i],
      _4373: f => f.dartFunction,
      _4374: () => ({}),
      _4375: () => [],
      _4377: () => globalThis,
      _4378: (constructor, args) => {
      ...
      _4380: (o, p) => o[p],
      _4381: (o, p, v) => o[p] = v,
      _4382: (o, m, a) => o[m].apply(o, a),
      _4384: o => String(o),
      _4385: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _4386: o => {
      ...
      _4387: o => [o],
      _4388: (o0, o1) => [o0, o1],
      _4389: (o0, o1, o2) => [o0, o1, o2],
      _4390: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _4395: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _4396: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _4397: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _4398: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _4399: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _4405: x0 => x0.groups,
      _4406: x0 => x0.flags,
      _4407: x0 => x0.multiline,
      _4408: x0 => x0.ignoreCase,
      _4409: x0 => x0.unicode,
      _4410: x0 => x0.dotAll,
      _4411: (x0,x1) => { x0.lastIndex = x1 },
      _4412: (o, p) => p in o,
      _4413: (o, p) => o[p],
      _4416: x0 => x0.random(),
      _4417: (x0,x1) => x0.getRandomValues(x1),
      _4418: () => globalThis.crypto,
      _4419: () => globalThis.Math,
      _4420: Function.prototype.call.bind(Number.prototype.toString),
      _4421: Function.prototype.call.bind(BigInt.prototype.toString),
      _4422: Function.prototype.call.bind(Number.prototype.toString),
      _4423: (d, digits) => d.toFixed(digits),
      _4460: () => globalThis.document,
      _4466: (x0,x1) => { x0.height = x1 },
      _4468: (x0,x1) => { x0.width = x1 },
      _4477: x0 => x0.style,
      _4480: x0 => x0.src,
      _4481: (x0,x1) => { x0.src = x1 },
      _4482: x0 => x0.naturalWidth,
      _4483: x0 => x0.naturalHeight,
      _4499: x0 => x0.status,
      _4500: (x0,x1) => { x0.responseType = x1 },
      _4502: x0 => x0.response,
      _4611: (x0,x1) => { x0.draggable = x1 },
      _4627: x0 => x0.style,
      _4640: (x0,x1) => { x0.oncancel = x1 },
      _4646: (x0,x1) => { x0.onchange = x1 },
      _4686: (x0,x1) => { x0.onerror = x1 },
      _5059: (x0,x1) => { x0.src = x1 },
      _5070: x0 => x0.width,
      _5072: x0 => x0.height,
      _5554: (x0,x1) => { x0.accept = x1 },
      _5568: x0 => x0.files,
      _5594: (x0,x1) => { x0.multiple = x1 },
      _5612: (x0,x1) => { x0.type = x1 },
      _5906: x0 => x0.width,
      _5907: (x0,x1) => { x0.width = x1 },
      _5908: x0 => x0.height,
      _5909: (x0,x1) => { x0.height = x1 },
      _6329: () => globalThis.window,
      _6367: x0 => x0.document,
      _6371: x0 => x0.history,
      _6389: x0 => x0.navigator,
      _6653: x0 => x0.localStorage,
      _6755: x0 => x0.geolocation,
      _6758: x0 => x0.mediaDevices,
      _6760: x0 => x0.permissions,
      _6761: x0 => x0.maxTouchPoints,
      _6768: x0 => x0.appCodeName,
      _6769: x0 => x0.appName,
      _6770: x0 => x0.appVersion,
      _6771: x0 => x0.platform,
      _6772: x0 => x0.product,
      _6773: x0 => x0.productSub,
      _6774: x0 => x0.userAgent,
      _6775: x0 => x0.vendor,
      _6776: x0 => x0.vendorSub,
      _6778: x0 => x0.language,
      _6779: x0 => x0.languages,
      _6785: x0 => x0.hardwareConcurrency,
      _6980: x0 => x0.length,
      _7269: x0 => x0.signalingState,
      _7270: x0 => x0.iceGatheringState,
      _7271: x0 => x0.iceConnectionState,
      _7272: x0 => x0.connectionState,
      _7285: (x0,x1) => { x0.onicegatheringstatechange = x1 },
      _7299: x0 => x0.type,
      _7301: x0 => x0.sdp,
      _7309: x0 => x0.candidate,
      _7310: x0 => x0.sdpMid,
      _7311: x0 => x0.sdpMLineIndex,
      _7333: x0 => x0.candidate,
      _7369: x0 => x0.track,
      _7502: x0 => x0.receiver,
      _7503: x0 => x0.track,
      _7504: x0 => x0.streams,
      _7505: x0 => x0.transceiver,
      _8861: x0 => x0.target,
      _8901: x0 => x0.signal,
      _8955: x0 => x0.baseURI,
      _8961: x0 => x0.firstChild,
      _8972: () => globalThis.document,
      _9053: x0 => x0.body,
      _9384: (x0,x1) => { x0.id = x1 },
      _9411: x0 => x0.children,
      _10730: x0 => x0.value,
      _10732: x0 => x0.done,
      _10911: x0 => x0.size,
      _10912: x0 => x0.type,
      _10918: x0 => x0.name,
      _10919: x0 => x0.lastModified,
      _10924: x0 => x0.length,
      _10929: x0 => x0.result,
      _11423: x0 => x0.url,
      _11425: x0 => x0.status,
      _11427: x0 => x0.statusText,
      _11428: x0 => x0.headers,
      _11429: x0 => x0.body,
      _11816: x0 => x0.state,
      _12213: x0 => x0.id,
      _12220: x0 => x0.kind,
      _12221: x0 => x0.id,
      _12222: x0 => x0.label,
      _12223: x0 => x0.enabled,
      _12224: (x0,x1) => { x0.enabled = x1 },
      _12225: x0 => x0.muted,
      _13119: x0 => x0.coords,
      _13120: x0 => x0.timestamp,
      _13122: x0 => x0.accuracy,
      _13123: x0 => x0.latitude,
      _13124: x0 => x0.longitude,
      _13125: x0 => x0.altitude,
      _13126: x0 => x0.altitudeAccuracy,
      _13127: x0 => x0.heading,
      _13128: x0 => x0.speed,
      _13129: x0 => x0.code,
      _13130: x0 => x0.message,
      _13816: (x0,x1) => { x0.display = x1 },
      _15038: x0 => x0.name,
      _15039: x0 => x0.message,
