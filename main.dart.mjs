...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1286: x0 => ({files: x0}),
      _1288: x0 => ({text: x0}),
      _1291: () => new MediaStream(),
      _1292: x0 => x0.getVideoTracks(),
      _1293: (x0,x1) => x0.addTrack(x1),
      _1294: x0 => x0.getAudioTracks(),
      _1295: (x0,x1) => x0.getElementById(x1),
      _1296: (x0,x1) => x0.removeAttribute(x1),
      _1297: x0 => x0.load(),
      ...
      _1399: x0 => x0.stop(),
      _1400: x0 => ({video: x0}),
      _1401: () => globalThis.Notification.requestPermission(),
      ...
      _1404: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1407: x0 => ({type: x0}),
      ...
      _1651: x0 => x0.read(),
      _1652: x0 => x0.cancel(),
      _4296: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4296(f,arguments.length,x0) }),
      _4297: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4297(f,arguments.length,x0) }),
      _4298: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4298(f,arguments.length,x0) }),
      _4304: (x0,x1) => x0.getContext(x1),
      _4346: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._4346(f,arguments.length,x0) }),
