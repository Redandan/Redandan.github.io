...
e5o(d,e){var x=new B.GM(e,d,A.aY("WebRTCManager"))
x.bUC()
return x},
...
B.GM.prototype={
WM(d){return this.drf(d)},
drf(d){var x=0,w=A.m(y.e),v,u=this
var $async$WM=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z3(new B.bUg(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WM)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$WM,w)},
bUC(){var x=this,w=x.a
x.y=w.gdhl().ee(new B.bU6(x),new B.bU7(x))
x.z=w.gdxE().ee(new B.bU8(x),new B.bU9(x))
x.Q=w.gdr8().ee(new B.bUa(x),new B.bUb(x))
x.as=w.gcib().ee(new B.bUc(x),new B.bUd(x))},
ab4(d){return this.cij(d)},
cij(d){var x=0,w=A.m(y.e),v,u=this
var $async$ab4=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z3(new B.bUh(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ab4)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$ab4,w)},
qj(d){return this.dfX(d)},
dfX(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qj=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z3(new B.bUe(u,d),"answerCall",t,y.e),$async$qj)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z3(new B.bUf(v),"endCall","Failed to end call",y.p),$async$tq)
case 2:return A.k(null,w)}})
return A.l($async$tq,w)},
bI5(){return D.dqi(new B.bUi(this),"toggleAudio","Failed to switch audio")},
ch_(d){this.e=d},
cgY(d){this.f=d},
...
bgv(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bgv=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bgv(),$async$$0)
case 5:case 4:s.a.bKo(q)
...
x=3
return A.c(q.bbE(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bI5()},
$S:29};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GM,A.V)
w(A.h9,[B.bUg,B.bUh,B.bUe,B.bUf,B.bUi])
w(A.fi,[B.bU6,B.bU7,B.bU8,B.bU9,B.bUa,B.bUb,B.bUc,B.bUd])})()
A.fT(b.typeUniverse,JSON.parse('{"GM":{"a6N":[],"azb":[]}}'))
var y={p:A.au("bo"),e:A.au("P"),b:A.au("@"),f:A.au("~")}};
(a=>{a["mlCDORNznnsiXp/UwrUUD/ELyZk="]=a.current})($__dart_deferred_initializers__);