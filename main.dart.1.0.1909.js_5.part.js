...
_.f=i
_.r=j},
ehX(d){var x=b.G,w=A.f0(new B.dd2(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.dd1(w)},
ehY(d){var x=b.G,w=A.f0(new B.dd4(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.dd3(w)},
doF(d){B.dny(A.bC(d),b.G.window.location.origin)},
...
dBZ(d,e){return new B.Gk(d,e,null)},
...
if(w)return null
return x.cak("telegram.me")},
dox(d){return d.c?d:A.dt_(A.bz(d),A.bB(d),A.c2(d),A.hr(d),A.mr(d),A.My(d),A.aDu(d),d.b)},
e3O(d){var x
if(d==null||d.length===0)return null
x=A.dBX().j(0,d)
return(x==null?null:x.e===C.i8)===!1?x:null},
zR(d,e,f,g){var x=null
return B.dWP(d,e,f,g)},
dWP(d,e,f,a0){var x=0,w=A.m(y.N),v,u=2,t=[],s,r,q,p,o,n,m,l,k,j,i,h,g
...
k=i
x=7
return A.c((k==null?A.dJo():k).$0(),$async$zR)
case 7:s=a2
r=s.a.j(0,a0)
...
a8l(d,e){var x=null
return B.dWO(d,e)},
dWO(d,e){var x=0,w=A.m(y.H),v=1,u=[],t,s,r,q,p,o,n,m,l,k
...
p=m
x=6
return A.c((p==null?A.dJo():p).$0(),$async$a8l)
case 6:t=g
p=J.aL(l)
case 7:if(!p.F()){x=8
break}s=p.gN()
...
xW(){return this.cuB()},
cuB(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
lH(d,e){return this.d9q(d,!0)},
d9p(d){return this.lH(!0,d)},
d9q(b9,c0){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8
...
E8(d,e,f){return this.cF5(d,!0,f)},
cF5(d,e,f){var x=0,w=A.m(y.y),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k
...
bcx(d){var x=A.dwo(d),w=x==null?null:C.b.G(x)
...
return B.dof(D.PR,this.cy,"product-"+x)},
gbVE(){var x=this.d
x=x==null?null:x.a
if(x==null)x=this.a.c
if(x==null)x="unknown"
return B.dof(D.PR,this.cy,x)},
gc_a(){var x=this.d
x=x==null?null:x.a
if(x==null)x=this.a.c
if(x==null)x="unknown"
return B.dof(D.aO1,this.cy,x)},
...
return e},
cVr(d,e){switch(e){case D.iB:return d.gaaj()
...
Eg(d){return this.cPC(d)},
cPC(b6){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5
...
if(u)v.push(new A.dF(!0,!0,!0,!0,C.J,!1,new A.cd(C.ik,s,s,A.aM(s,s,s,s,s,D.aT3,s,s,t.gbvj(),s,s,s,s,r.gh3(),s),s),s))
return A.bM(s,D.auR,A.d2(C.aU,v,C.t,C.aQ,s),s,s,s,s,s)},
csS(a1){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e=this,d=null,a0=A.f(a1,C.c,y.J)
a0.toString
x=e.d
w=e.ay
v=e.e
...
return C.yC}return new B.aed(w.bSJ(t,Date.now()),w.gd6r(),null)},
bSJ(d,e){var x="/games/"+d
return x+(C.b.t(x,"?")?"&":"?")+"flutter=1&_ts="+e},
d6s(){new B.cQK(this).$0()}}
B.ayx.prototype={
u(d){var x=A.f(d,C.c,y.J)
x.toString
return new A.dF(!0,!0,!0,!0,C.J,!1,A.d1(new B.bkd(this,x,A.p(d),this.cH_(x))),null)},
cH_(d){switch(this.d.gmZ().a){case 1:return d.gDg()
case 2:return d.gXw()
...
x.d=new A.xL(w.b,w.gdo0(),"Telegram Mini App",null,C.i8,4279724935,"\ud83c\udfae",null,!1)
x.fx=!0
x.id=null},
$S:0}
B.cQs.prototype={
...
$S:36}
B.cQ0.prototype={
$0(){return this.a.cOt(this.b.gmZ())},
$S:0}
B.cQ1.prototype={
$0(){this.a.bxr()
return null},
$S:0}
B.cQ4.prototype={
$1(d){return this.cbY(d)},
cbY(d){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e
...
x($,"eqL","dNm",()=>A.bj("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"erJ","hK",()=>A.aY("SlotGamePage"))})()};
(a=>{a["SW5Du01mEyJj/YuS50SlaXtP68o="]=a.current})($__dart_deferred_initializers__);