...
e0B(d,e){var x=new B.HC(e,d,A.aW("WebRTCManager"))
x.bXs()
return x},
...
B.HC.prototype={
Xz(d){return this.dut(d)},
dut(d){var x=0,w=A.l(y.e),v,u=this
var $async$Xz=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yN(new B.bUH(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$Xz)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$Xz,w)},
bXs(){var x=this,w=x.a
x.y=w.gdkE().ed(new B.bUx(x),new B.bUy(x))
x.z=w.gdB2().ed(new B.bUz(x),new B.bUA(x))
x.Q=w.gdum().ed(new B.bUB(x),new B.bUC(x))
x.as=w.gclf().ed(new B.bUD(x),new B.bUE(x))},
abZ(d){return this.cln(d)},
cln(d){var x=0,w=A.l(y.e),v,u=this
var $async$abZ=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yN(new B.bUI(u,d),"startAudioCall","Failed to start audio call",y.e),$async$abZ)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$abZ,w)},
qv(d){return this.dje(d)},
dje(d){var x=0,w=A.l(y.e),v,u=this,t
...
return A.c(D.yN(new B.bUG(v),"endCall","Failed to end call",y.p),$async$tE)
case 2:return A.j(null,w)}})
return A.k($async$tE,w)},
bKS(){return D.dro(new B.bUJ(this),"toggleAudio","Failed to switch audio")},
ck1(d){this.e=d},
ck_(d){this.f=d},
ck0(d){var x=null,w=this.c
...
bj7(){var x=0,w=A.l(y.f),v=this,u,t
var $async$bj7=A.h(function(d,e){if(d===1)return A.i(e,w)
...
A.fu(b.typeUniverse,JSON.parse('{"HC":{"a4J":[],"awq":[]}}'))
var y={p:A.au("bn"),e:A.au("N"),b:A.au("@"),f:A.au("~")}};
(a=>{a["rDbSyjxmSddWVXEDemZynH5WdyM="]=a.current})($__dart_deferred_initializers__);