...
dUJ(d,e){var x=new B.FN(e,d,A.aU("WebRTCManager"))
x.bNI()
return x},
...
B.FN.prototype={
OG(d){return this.dhy(d)},
dhy(d){var x=0,w=A.m(y.e),v,u=this
var $async$OG=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yA(new B.bPb(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$OG)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$OG,w)},
bNI(){var x=this,w=x.a
x.y=w.gd7V().e2(new B.bP1(x),new B.bP2(x))
x.z=w.gdnD().e2(new B.bP3(x),new B.bP4(x))
x.Q=w.gdhq().e2(new B.bP5(x),new B.bP6(x))
x.as=w.gcaH().e2(new B.bP7(x),new B.bP8(x))},
U0(d){return this.caP(d)},
caP(d){var x=0,w=A.m(y.e),v,u=this
var $async$U0=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yA(new B.bPc(u,d),"startAudioCall","Failed to start audio call",y.e),$async$U0)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$U0,w)},
qa(d){return this.d6C(d)},
d6C(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qa=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yA(new B.bP9(u,d),"answerCall",t,y.e),$async$qa)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yA(new B.bPa(v),"endCall","Failed to end call",y.p),$async$t0)
case 2:return A.k(null,w)}})
return A.l($async$t0,w)},
bBt(){return D.dgF(new B.bPd(this),"toggleAudio","Failed to switch audio")},
c9w(d){this.e=d},
c9u(d){this.f=d},
...
return!1}return x.a.bBt()},
$S:35};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.FN,A.U)
w(A.h3,[B.bPb,B.bPc,B.bP9,B.bPa,B.bPd])
w(A.fd,[B.bP1,B.bP2,B.bP3,B.bP4,B.bP5,B.bP6,B.bP7,B.bP8])})()
A.fM(b.typeUniverse,JSON.parse('{"FN":{"a4n":[],"awt":[]}}'))
var y={p:A.aw("bl"),e:A.aw("I"),b:A.aw("@"),f:A.aw("~")}};
(a=>{a["WsoDfVYJVcmkXuiey4ptu2hnpmo="]=a.current})($__dart_deferred_initializers__);