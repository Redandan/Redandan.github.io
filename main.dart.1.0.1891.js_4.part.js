...
e3C(d,e){var x=new B.GC(e,d,A.aY("WebRTCManager"))
x.bTl()
return x},
...
B.GC.prototype={
Wu(d){return this.dpK(d)},
dpK(d){var x=0,w=A.m(y.e),v,u=this
var $async$Wu=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z_(new B.bTG(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$Wu)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Wu,w)},
bTl(){var x=this,w=x.a
x.y=w.gdfQ().ec(new B.bTw(x),new B.bTx(x))
x.z=w.gdw6().ec(new B.bTy(x),new B.bTz(x))
x.Q=w.gdpD().ec(new B.bTA(x),new B.bTB(x))
x.as=w.gcgL().ec(new B.bTC(x),new B.bTD(x))},
aaq(d){return this.cgT(d)},
cgT(d){var x=0,w=A.m(y.e),v,u=this
var $async$aaq=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z_(new B.bTH(u,d),"startAudioCall","Failed to start audio call",y.e),$async$aaq)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$aaq,w)},
qd(d){return this.der(d)},
der(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qd=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z_(new B.bTE(u,d),"answerCall",t,y.e),$async$qd)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z_(new B.bTF(v),"endCall","Failed to end call",y.p),$async$tk)
case 2:return A.k(null,w)}})
return A.l($async$tk,w)},
bGN(){return D.doO(new B.bTI(this),"toggleAudio","Failed to switch audio")},
cfz(d){this.e=d},
cfx(d){this.f=d},
cfy(d){var x=null,w=this.c
...
cfw(d){this.w=d},
gbDh(){return this.d},
gaJc(){return this.a.gaJc()},
gaJh(){return this.a.gaJh()},
gaxP(){return this.a.gaxP()},
bfh(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bfh=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bfh(),$async$$0)
case 5:case 4:s.a.bJ5(q)
...
q=q.a
t.k(C.h,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.gaJc(),null,null)
x=3
return A.c(q.bar(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bGN()},
$S:29};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GC,A.V)
w(A.h8,[B.bTG,B.bTH,B.bTE,B.bTF,B.bTI])
w(A.fi,[B.bTw,B.bTx,B.bTy,B.bTz,B.bTA,B.bTB,B.bTC,B.bTD])})()
A.fT(b.typeUniverse,JSON.parse('{"GC":{"a6x":[],"ayS":[]}}'))
var y={p:A.au("bo"),e:A.au("P"),b:A.au("@"),f:A.au("~")}};
(a=>{a["8KaLsYPtOtt9TmJCBgU9O9yPWPE="]=a.current})($__dart_deferred_initializers__);