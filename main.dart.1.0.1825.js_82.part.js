...
e6H(d){var x=b.G,w=A.eT(new B.d4K(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d4J(w)},
e6I(d){var x=b.G,w=A.eT(new B.d4M(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d4L(w)},
dfY(d){B.deY(A.bz(d),b.G.window.location.origin)},
deY(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
...
u.e!==$&&A.be()
u.e=w
v=A.eT(new B.cJG(u.a.d))
u.f=v
w.addEventListener("load",v)
w.src=u.a.c
$.b0a()
$.Ce().QB(x,new B.cJH(u),!0)},
aI(d){var x,w
this.b0(d)
x=this.a.c
if(d.c!==x){w=this.e
...
u(d){var x=this.d
x===$&&A.h()
return A.dbR(null,C.Et,x)}}
B.FA.prototype={
T(){var x=$.aA()
return new B.am2(x.$1$0(y.w),x.$1$0(y.r),x.$1$0(y.A))}}
B.am2.prototype={
a_(){var x,w=this
w.a6()
x=w.a.c
A.dsE().j(0,x)
x=w.cpu("moon_dance/index.html")
w.d!==$&&A.be()
w.d=x
w.Q=B.e6H(w.gbMR())
w.as=B.e6I(w.gcHe())
w.W4()
w.z=w.Xl()},
W4(){var x=0,w=A.m(y.H),v=1,u=[],t=this,s,r,q,p,o,n,m,l,k,j,i
var $async$W4=A.i(function(d,e){if(d===1){u.push(e)
x=v}for(;;)switch(x){case 0:v=3
x=6
return A.c(t.f.hP(),$async$W4)
case 6:s=e
if(t.c!=null&&s!=null){t.p(new B.cJL(t,s))
...
case 5:v=8
x=11
return A.c(t.e.eq(!0),$async$W4)
case 11:p=e
if(t.c!=null){l=p
k=l==null?null:l.f
o=k==null?0:k
t.p(new B.cJM(t,o))
try{b.G.window.localStorage.setItem("_flutter_game_balance",J.a1M(o,4))}catch(h){n=A.t(h)
$.r2().k(C.aC,"localStorage balance write failed",n,null)}}v=1
x=10
break
case 8:v=7
i=u.pop()
if(t.c!=null)t.p(new B.cJN(t))
x=10
break
case 7:x=1
break
...
return A.l($async$W4,w)},
xf(){return this.cmC()},
cmC(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
case 9:a1=a7
a0.a=a1
if(s.c!=null&&a1!=null)s.p(new B.cJI(a0,s))
u=2
x=8
break
case 6:u=5
...
j=h==null?null:h.f
a0.b=j==null?0:j
if(s.c!=null)s.p(new B.cJJ(a0,s))
...
Wj(){var x=0,w=A.m(y.h),v,u=this,t,s
...
x=7
return A.c(r.r.aaU(r.a.c),$async$Xl)
case 7:q=e
if(J.r(J.aC(q,"success"),!0)&&y.f.b(J.aC(q,"data"))){p=A.wt(y.f.a(J.aC(q,"data")),y.N,y.z)
r.y=p
...
Cy(d){return this.cHf(d)},
cHf(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
...
break
case 7:n=s.c
if(n!=null)A.aX(n,!1).f.aQ(C.Ah,y.X)
v=null
x=1
break
case 8:n=s.c
if(n!=null)A.aX(n,!1).f.aQ(C.yi,y.X)
v=null
x=1
break
case 9:u=15
a9=A.mu(b5.j(0,"betIndex"))
r=a9==null?null:C.j.cd(a9)
a1=A.mu(b5.j(0,"betAmount"))
q=a1==null?null:a1
...
x=18
return A.c(s.r.U3(q,r,A.aW(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$Cy)
case 18:p=b7
o=J.aC(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.SA(f,e),$async$Cy)
case 33:d=b7
if(J.r(J.aC(d,"success"),!0)){n=A.a9(["type","TRANSACTION_RESULT","data",J.aC(d,"data")],y.N,y.z)
v=n
x=1
...
w===$&&A.h()
return A.bQ(x,D.as7,A.d4(C.aT,A.b([w,A.dH(0,A.h7(C.ca,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbMR(),x,x,x,x,x,x,!1,C.bR),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
Wo(){var x=0,w=A.m(y.H),v,u=this
var $async$Wo=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:if(u.c==null){x=1
break}x=3
return A.c(u.apL(),$async$Wo)
case 3:case 1:return A.k(v,w)}})
return A.l($async$Wo,w)},
apL(){var x=0,w=A.m(y.H),v,u=this,t
var $async$apL=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:t=u.c
if(t==null){x=1
break}x=3
return A.c(A.a0(t,!1).zm(),$async$apL)
case 3:if(!e&&u.c!=null){t=u.c
t.toString
A.aX(t,!1).f.ii("/home",y.X)}case 1:return A.k(v,w)}})
return A.l($async$apL,w)},
cpu(d){var x=b.G.window.navigator.userAgent,w=$.dDj()
if(w.b.test(x)){$.aE.y2$.push(new B.cJK(this,d))
return C.xK}return new B.acg("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcYo(),null)},
cYp(){new B.cJP(this).$0()}}
...
s=v.d
if(r){A.axE(t,"postMessage",u,s,y.X)
B.deY(u,s)}else{B.deY(u,s)
...
l.window.localStorage.setItem("_flutter_game_balance",J.a1M(q,4))
l.window.localStorage.setItem("_flutter_game_api_base",g.r.amm())
l.window.localStorage.setItem("_flutter_game_id",g.a.c)
u=19
x=22
return A.c(g.Wj(),$async$$1)
case 22:u=4
x=21
break
case 19:u=18
...
if(g==null){x=1
break}x=23
return A.c(A.a0(g,!1).zm(),$async$$1)
case 23:h=Date.now()
...
case 3:B.dfY(t)
x=4
return A.c(A.d_(D.aGc,null,u),$async$$0)
case 4:B.dfY(t)
return A.k(null,w)}})
return A.l($async$$0,w)},
$S:88};(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
var v
x(v=B.am2.prototype,"gcHe","Cy",0)
w(v,"gbMR","Wo",1)
w(v,"gcYo","cYp",2)})();(function inheritance(){var x=a.inheritMany
x(A.fe,[B.d4K,B.d4M,B.cJG,B.cJH,B.cJK])
x(A.h4,[B.d4J,B.d4N,B.d4L,B.cJL,B.cJM,B.cJN,B.cJI,B.cJJ,B.cJO,B.cJP])
x(A.W,[B.acg,B.FA])
x(A.a_,[B.aVW,B.am2])})()
A.fP(b.typeUniverse,JSON.parse('{"acg":{"W":[],"n":[]},"aVW":{"a_":["acg"]},"FA":{"W":[],"n":[]},"am2":{"a_":["FA"]}}'))
var y=(function rtii(){var x=A.aw
return{u:x("ac<V<q,@>?>"),w:x("biV"),p:x("E<n>"),P:x("V<q,@>"),f:x("V<@,@>"),a:x("bm"),A:x("Ng"),N:x("q"),r:x("NW"),z:x("@"),h:x("V<q,@>?"),X:x("U?"),H:x("~")}})();(function constants(){D.as7=new A.Z(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
D.aGc=new A.bG(175e4)
D.aGu=new A.bG(75e4)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"ef6","dDj",()=>A.bs("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"eg4","r2",()=>A.aU("SlotGamePage"))})()};
(a=>{a["x3LBmeHixdJTUpkQrLgnkGdjxO0="]=a.current})($__dart_deferred_initializers__);