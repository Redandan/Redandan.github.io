...
e5Z(d,e){var x=new B.GP(e,d,A.aY("WebRTCManager"))
x.bUR()
return x},
...
B.GP.prototype={
WR(d){return this.drz(d)},
drz(d){var x=0,w=A.m(y.e),v,u=this
var $async$WR=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z4(new B.bUy(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WR)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$WR,w)},
bUR(){var x=this,w=x.a
x.y=w.gdhF().ee(new B.bUo(x),new B.bUp(x))
x.z=w.gdxZ().ee(new B.bUq(x),new B.bUr(x))
x.Q=w.gdrs().ee(new B.bUs(x),new B.bUt(x))
x.as=w.gciu().ee(new B.bUu(x),new B.bUv(x))},
ab9(d){return this.ciC(d)},
ciC(d){var x=0,w=A.m(y.e),v,u=this
var $async$ab9=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z4(new B.bUz(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ab9)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$ab9,w)},
qk(d){return this.dgg(d)},
dgg(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qk=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z4(new B.bUw(u,d),"answerCall",t,y.e),$async$qk)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$qk,w)},
tt(){var x=0,w=A.m(y.f),v=this
var $async$tt=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:x=2
return A.c(D.z4(new B.bUx(v),"endCall","Failed to end call",y.p),$async$tt)
case 2:return A.k(null,w)}})
return A.l($async$tt,w)},
bIk(){return D.dqI(new B.bUA(this),"toggleAudio","Failed to switch audio")},
chi(d){this.e=d},
chg(d){this.f=d},
...
chf(d){this.w=d},
gbEP(){return this.d},
gaKa(){return this.a.gaKa()},
gaKf(){return this.a.gaKf()},
gayN(){return this.a.gayN()},
bgL(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bgL=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bgL(),$async$$0)
case 5:case 4:s.a.bKD(q)
...
x=10
return A.c(A.dd(C.cx,null,y.b),$async$$0)
...
q=q.a
t.k(C.h,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.gaKa(),null,null)
x=3
return A.c(q.bbT(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bIk()},
$S:28};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GP,A.V)
w(A.ha,[B.bUy,B.bUz,B.bUw,B.bUx,B.bUA])
w(A.fi,[B.bUo,B.bUp,B.bUq,B.bUr,B.bUs,B.bUt,B.bUu,B.bUv])})()
A.fU(b.typeUniverse,JSON.parse('{"GP":{"a6S":[],"azh":[]}}'))
var y={p:A.au("bo"),e:A.au("Q"),b:A.au("@"),f:A.au("~")}};
(a=>{a["TGyFG4EIGFIfZ81wyz3KdmwC+5o="]=a.current})($__dart_deferred_initializers__);