...
ea6(d){var x=b.G,w=A.eY(new B.d7s(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d7r(w)},
ea7(d){var x=b.G,w=A.eY(new B.d7u(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d7t(w)},
diL(d){B.dhJ(A.bB(d),b.G.window.location.origin)},
dhJ(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
...
this.b=e},
d7v:function d7v(d,e,f,g){var _=this
_.a=d
_.b=e
_.c=f
_.d=g},
...
u.e!==$&&A.b2()
u.e=w
v=A.eY(new B.cLM(u.a.d))
u.f=v
w.addEventListener("load",v)
w.src=u.a.c
$.b0X()
$.Cq().Rd(x,new B.cLN(u),!0)},
aK(d){var x,w
this.b1(d)
x=this.a.c
if(d.c!==x){w=this.e
...
u(d){var x=this.d
x===$&&A.h()
return A.deA(null,C.ER,x)}}
B.FO.prototype={
T(){var x=$.az()
return new B.amN(x.$1$0(y.w),x.$1$0(y.r),x.$1$0(y.A))}}
B.amN.prototype={
a0(){var x,w=this
w.a5()
x=w.a.c
A.dvs().j(0,x)
x=w.csa("moon_dance/index.html")
w.d!==$&&A.b2()
w.d=x
w.Q=B.ea6(w.gbPa())
w.as=B.ea7(w.gcJQ())
w.Wy()
w.z=w.XS()},
Wy(){var x=0,w=A.m(y.H),v=1,u=[],t=this,s,r,q,p,o,n,m,l,k,j,i
var $async$Wy=A.i(function(d,e){if(d===1){u.push(e)
x=v}for(;;)switch(x){case 0:v=3
x=6
return A.c(t.f.hP(),$async$Wy)
case 6:s=e
if(t.c!=null&&s!=null){t.p(new B.cLR(t,s))
...
case 5:v=8
x=11
return A.c(t.e.eq(!0),$async$Wy)
case 11:p=e
if(t.c!=null){l=p
k=l==null?null:l.f
o=k==null?0:k
t.p(new B.cLS(t,o))
try{b.G.window.localStorage.setItem("_flutter_game_balance",J.a2N(o,4))}catch(h){n=A.t(h)
$.rb().k(C.aE,"localStorage balance write failed",n,null)}}v=1
x=10
break
case 8:v=7
i=u.pop()
if(t.c!=null)t.p(new B.cLT(t))
x=10
break
case 7:x=1
break
...
xn(){return this.cpe()},
cpe(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
case 9:a1=a7
a0.a=a1
if(s.c!=null&&a1!=null)s.p(new B.cLO(a0,s))
u=2
x=8
break
case 6:u=5
...
j=h==null?null:h.f
a0.b=j==null?0:j
if(s.c!=null)s.p(new B.cLP(a0,s))
...
WN(){var x=0,w=A.m(y.h),v,u=this,t,s
var $async$WN=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:s=u.y
if(s!=null){v=s
x=1
break}t=u.z
if(t==null)t=u.z=u.XS()
v=t.wk(C.NA,new B.cLU())
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$WN,w)},
XS(){var x=0,w=A.m(y.h),v,u=2,t=[],s=[],r=this,q,p,o,n,m,l
var $async$XS=A.i(function(d,e){if(d===1){t.push(e)
x=u}for(;;)switch(x){case 0:u=4
x=7
return A.c(r.r.abN(r.a.c),$async$XS)
case 7:q=e
if(J.r(J.aC(q,"success"),!0)&&y.f.b(J.aC(q,"data"))){p=A.uo(y.f.a(J.aC(q,"data")),y.N,y.z)
r.y=p
...
case 1:return A.k(v,w)
case 2:return A.j(t.at(-1),w)}})
return A.l($async$XS,w)},
CM(d){return this.cJR(d)},
cJR(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
...
x=18
return A.c(s.r.Us(q,r,A.aX(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$CM)
case 18:p=b7
o=J.aC(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.SW(f,e),$async$CM)
case 33:d=b7
...
w===$&&A.h()
return A.bN(x,D.at1,A.d4(C.aT,A.b([w,A.dK(0,A.h9(C.cb,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbPa(),x,x,x,x,x,x,!1,C.bV),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
WS(){var x=0,w=A.m(y.H),v,u=this
var $async$WS=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:if(u.c==null){x=1
break}x=3
return A.c(u.ar4(),$async$WS)
case 3:case 1:return A.k(v,w)}})
return A.l($async$WS,w)},
ar4(){var x=0,w=A.m(y.H),v,u=this,t
var $async$ar4=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:t=u.c
if(t==null){x=1
break}x=3
return A.c(A.X(t,!1).zx(),$async$ar4)
case 3:if(!e&&u.c!=null){t=u.c
t.toString
A.aZ(t,!1).f.ij("/home",y.X)}case 1:return A.k(v,w)}})
return A.l($async$ar4,w)},
csa(d){var x=b.G.window.navigator.userAgent,w=$.dGg()
if(w.b.test(x)){$.aE.y2$.push(new B.cLQ(this,d))
return C.y3}return new B.acW("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gd0i(),null)},
d0j(){new B.cLV(this).$0()}}
...
s=v.d
if(r){A.aym(t,"postMessage",u,s,y.X)
B.dhJ(u,s)}else{B.dhJ(u,s)
...
$S:16}
B.cLQ.prototype={
$1(d){return this.c6R(d)},
c6R(a0){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d
...
l.window.localStorage.setItem("_flutter_game_balance",J.a2N(q,4))
l.window.localStorage.setItem("_flutter_game_api_base",g.r.anH())
l.window.localStorage.setItem("_flutter_game_id",g.a.c)
u=19
x=22
return A.c(g.WN(),$async$$1)
case 22:u=4
x=21
break
case 19:u=18
...
case 3:B.diL(t)
x=4
return A.c(A.d_(D.aHK,null,u),$async$$0)
case 4:B.diL(t)
return A.k(null,w)}})
return A.l($async$$0,w)},
$S:86};(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
var v
x(v=B.amN.prototype,"gcJQ","CM",0)
w(v,"gbPa","WS",1)
w(v,"gd0i","d0j",2)})();(function inheritance(){var x=a.inheritMany
x(A.fg,[B.d7s,B.d7u,B.cLM,B.cLN,B.cLQ])
x(A.fY,[B.d7r,B.d7v,B.d7t,B.cLR,B.cLS,B.cLT,B.cLO,B.cLP,B.cLU,B.cLV])
x(A.V,[B.acW,B.FO])
x(A.Z,[B.aWK,B.amN])})()
A.fI(b.typeUniverse,JSON.parse('{"acW":{"V":[],"n":[]},"aWK":{"Z":["acW"]},"FO":{"V":[],"n":[]},"amN":{"Z":["FO"]}}'))
var y=(function rtii(){var x=A.at
return{u:x("ab<U<q,@>?>"),w:x("bjQ"),p:x("E<n>"),P:x("U<q,@>"),f:x("U<@,@>"),a:x("bn"),A:x("Ny"),N:x("q"),r:x("Od"),z:x("@"),h:x("U<q,@>?"),X:x("W?"),H:x("~")}})();(function constants(){D.at1=new A.Y(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
D.aHK=new A.bJ(175e4)
D.aI1=new A.bJ(75e4)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"eiy","dGg",()=>A.bu("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"ejw","rb",()=>A.aU("SlotGamePage"))})()};
(a=>{a["bgHsngCBWBnDVkfw74gqi5bW1ak="]=a.current})($__dart_deferred_initializers__);