...
e6X(d,e){var x=new B.GS(e,d,A.aY("WebRTCManager"))
x.bV8()
return x},
...
B.GS.prototype={
WV(d){return this.ds9(d)},
ds9(d){var x=0,w=A.m(y.e),v,u=this
var $async$WV=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z6(new B.bUW(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WV)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$WV,w)},
bV8(){var x=this,w=x.a
x.y=w.gdif().ee(new B.bUM(x),new B.bUN(x))
x.z=w.gdyz().ee(new B.bUO(x),new B.bUP(x))
x.Q=w.gds2().ee(new B.bUQ(x),new B.bUR(x))
x.as=w.gciR().ee(new B.bUS(x),new B.bUT(x))},
abe(d){return this.ciZ(d)},
ciZ(d){var x=0,w=A.m(y.e),v,u=this
var $async$abe=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z6(new B.bUX(u,d),"startAudioCall","Failed to start audio call",y.e),$async$abe)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$abe,w)},
qk(d){return this.dgR(d)},
dgR(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$qk=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.z6(new B.bUU(u,d),"answerCall",t,y.e),$async$qk)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z6(new B.bUV(v),"endCall","Failed to end call",y.p),$async$tu)
case 2:return A.k(null,w)}})
return A.l($async$tu,w)},
bIB(){return D.drz(new B.bUY(this),"toggleAudio","Failed to switch audio")},
chF(d){this.e=d},
chD(d){this.f=d},
chE(d){var x=null,w=this.c
...
chC(d){this.w=d},
gbF5(){return this.d},
gaKh(){return this.a.gaKh()},
gaKm(){return this.a.gaKm()},
gayU(){return this.a.gayU()},
bgS(){var x=0,w=A.m(y.f),v=this,u,t
var $async$bgS=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.bgS(),$async$$0)
case 5:case 4:s.a.bKU(q)
...
q=q.a
t.k(C.h,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.gaKh(),null,null)
x=3
return A.c(q.bbZ(s,"audio"),$async$$0)
case 3:r=e
...
return!1}return x.a.bIB()},
$S:29};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.GS,A.V)
w(A.ha,[B.bUW,B.bUX,B.bUU,B.bUV,B.bUY])
w(A.fi,[B.bUM,B.bUN,B.bUO,B.bUP,B.bUQ,B.bUR,B.bUS,B.bUT])})()
A.fU(b.typeUniverse,JSON.parse('{"GS":{"a72":[],"azu":[]}}'))
var y={p:A.au("bo"),e:A.au("Q"),b:A.au("@"),f:A.au("~")}};
(a=>{a["GSh/hJ44dtccZpc4zFEL76nnmr4="]=a.current})($__dart_deferred_initializers__);