...
e3S(d){var x=b.G,w=A.eS(new B.d2B(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d2A(w)},
e3T(d){var x=b.G,w=A.eS(new B.d2D(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d2C(w)},
ddP(d){B.dcP(A.bz(d),b.G.window.location.origin)},
dcP(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
...
u(d){var x=this.d
x===$&&A.h()
return A.d9I(null,C.Ej,x)}}
B.Fj.prototype={
S(){var x=$.az()
return new B.all(x.$1$0(y.w),x.$1$0(y.r),x.$1$0(y.A))}}
B.all.prototype={
a_(){var x,w=this
w.a6()
x=w.a.c
A.dq9().j(0,x)
x=w.coO("moon_dance/index.html")
w.d!==$&&A.bj()
w.d=x
w.Q=B.e3S(w.gbMo())
w.as=B.e3T(w.gcGm())
w.VS()
w.z=w.X7()},
VS(){var x=0,w=A.m(y.H),v=1,u=[],t=this,s,r,q,p,o,n,m,l,k,j,i
var $async$VS=A.i(function(d,e){if(d===1){u.push(e)
x=v}for(;;)switch(x){case 0:v=3
x=6
return A.c(t.f.hP(),$async$VS)
case 6:s=e
...
case 5:v=8
x=11
return A.c(t.e.eq(!0),$async$VS)
case 11:p=e
if(t.c!=null){l=p
k=l==null?null:l.f
o=k==null?0:k
t.p(new B.cHZ(t,o))
try{b.G.window.localStorage.setItem("_flutter_game_balance",J.a1b(o,4))}catch(h){n=A.t(h)
...
xe(){return this.cm1()},
cm1(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
W6(){var x=0,w=A.m(y.h),v,u=this,t,s
var $async$W6=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:s=u.y
if(s!=null){v=s
x=1
break}t=u.z
if(t==null)t=u.z=u.X7()
v=t.wc(C.MN,new B.cI0())
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$W6,w)},
X7(){var x=0,w=A.m(y.h),v,u=2,t=[],s=[],r=this,q,p,o,n,m,l
var $async$X7=A.i(function(d,e){if(d===1){t.push(e)
x=u}for(;;)switch(x){case 0:u=4
x=7
return A.c(r.r.aaE(r.a.c),$async$X7)
case 7:q=e
...
case 1:return A.k(v,w)
case 2:return A.j(t.at(-1),w)}})
return A.l($async$X7,w)},
Cw(d){return this.cGn(d)},
cGn(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
...
break
case 7:n=s.c
if(n!=null)A.aX(n,!1).f.aP(C.A8,y.X)
v=null
x=1
break
case 8:n=s.c
if(n!=null)A.aX(n,!1).f.aP(C.y7,y.X)
v=null
x=1
break
case 9:u=15
...
x=18
return A.c(s.r.TS(q,r,A.aW(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$Cw)
case 18:p=b7
o=J.aB(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.So(f,e),$async$Cw)
case 33:d=b7
...
w===$&&A.h()
return A.bP(x,D.aro,A.d4(C.aS,A.b([w,A.dH(0,A.h6(C.c9,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbMo(),x,x,x,x,x,x,!1,C.bR),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
Wb(){var x=0,w=A.m(y.H),v,u=this
var $async$Wb=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:if(u.c==null){x=1
break}x=3
return A.c(u.aps(),$async$Wb)
case 3:case 1:return A.k(v,w)}})
return A.l($async$Wb,w)},
aps(){var x=0,w=A.m(y.H),v,u=this,t
var $async$aps=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:t=u.c
if(t==null){x=1
break}x=3
return A.c(A.a_(t,!1).zj(),$async$aps)
case 3:if(!e&&u.c!=null){t=u.c
t.toString
A.aX(t,!1).f.ii("/home",y.X)}case 1:return A.k(v,w)}})
return A.l($async$aps,w)},
coO(d){var x=b.G.window.navigator.userAgent,w=$.dAJ()
if(w.b.test(x)){$.aD.y2$.push(new B.cHX(this,d))
return C.xy}return new B.abC("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcXk(),null)},
cXl(){new B.cI1(this).$0()}}
...
s=v.d
if(r){A.awP(t,"postMessage",u,s,y.X)
B.dcP(u,s)}else{B.dcP(u,s)
...
c3X(a0){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d
...
l.window.localStorage.setItem("_flutter_game_balance",J.a1b(q,4))
l.window.localStorage.setItem("_flutter_game_api_base",g.r.am5())
l.window.localStorage.setItem("_flutter_game_id",g.a.c)
u=19
x=22
return A.c(g.W6(),$async$$1)
case 22:u=4
x=21
break
case 19:u=18
...
if(g==null){x=1
break}x=23
return A.c(A.a_(g,!1).zj(),$async$$1)
case 23:h=Date.now()
...
var v
x(v=B.all.prototype,"gcGm","Cw",0)
w(v,"gbMo","Wb",1)
w(v,"gcXk","cXl",2)})();(function inheritance(){var x=a.inheritMany
x(A.fd,[B.d2B,B.d2D,B.cHT,B.cHU,B.cHX])
x(A.h3,[B.d2A,B.d2E,B.d2C,B.cHY,B.cHZ,B.cI_,B.cHV,B.cHW,B.cI0,B.cI1])
x(A.W,[B.abC,B.Fj])
x(A.a0,[B.aUY,B.all])})()
A.fM(b.typeUniverse,JSON.parse('{"abC":{"W":[],"n":[]},"aUY":{"a0":["abC"]},"Fj":{"W":[],"n":[]},"all":{"a0":["Fj"]}}'))
var y=(function rtii(){var x=A.aw
return{u:x("ad<V<q,@>?>"),w:x("bhJ"),p:x("E<n>"),P:x("V<q,@>"),f:x("V<@,@>"),a:x("bl"),A:x("MR"),N:x("q"),r:x("Nv"),z:x("@"),h:x("V<q,@>?"),X:x("U?"),H:x("~")}})();(function constants(){D.aro=new A.Y(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
D.aEx=new A.bF(175e4)
D.aEP=new A.bF(75e4)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"ecg","dAJ",()=>A.bs("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"ede","qY",()=>A.aU("SlotGamePage"))})()};
(a=>{a["GUfCffvrbHzYisrSrQDVAsvZFrc="]=a.current})($__dart_deferred_initializers__);