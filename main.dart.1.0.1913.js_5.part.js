...
e1_(d,e){var x=new B.HE(e,d,A.aX("WebRTCManager"))
x.bXT()
return x},
...
B.HE.prototype={
XD(d){return this.dv3(d)},
dv3(d){var x=0,w=A.l(y.e),v,u=this
var $async$XD=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yO(new B.bUU(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$XD)
case 3:v=f
x=1
break
...
x.y=w.gdle().ed(new B.bUK(x),new B.bUL(x))
x.z=w.gdBD().ed(new B.bUM(x),new B.bUN(x))
x.Q=w.gduX().ed(new B.bUO(x),new B.bUP(x))
x.as=w.gclG().ed(new B.bUQ(x),new B.bUR(x))},
ac2(d){return this.clO(d)},
clO(d){var x=0,w=A.l(y.e),v,u=this
var $async$ac2=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yO(new B.bUV(u,d),"startAudioCall","Failed to start audio call",y.e),$async$ac2)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$ac2,w)},
qv(d){return this.djP(d)},
djP(d){var x=0,w=A.l(y.e),v,u=this,t
var $async$qv=A.h(function(e,f){if(e===1)return A.i(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yO(new B.bUS(u,d),"answerCall",t,y.e),$async$qv)
case 3:v=f
x=1
break
case 1:return A.j(v,w)}})
...
return A.c(D.yO(new B.bUT(v),"endCall","Failed to end call",y.p),$async$tE)
case 2:return A.j(null,w)}})
return A.k($async$tE,w)},
bLh(){return D.drM(new B.bUW(this),"toggleAudio","Failed to switch audio")},
cks(d){this.e=d},
ckq(d){this.f=d},
ckr(d){var x=null,w=this.c
...
bjw(){var x=0,w=A.l(y.f),v=this,u,t
var $async$bjw=A.h(function(d,e){if(d===1)return A.i(e,w)
...
x(B.HE,A.T)
w(A.hf,[B.bUU,B.bUV,B.bUS,B.bUT,B.bUW])
w(A.ff,[B.bUK,B.bUL,B.bUM,B.bUN,B.bUO,B.bUP,B.bUQ,B.bUR])})()
A.fu(b.typeUniverse,JSON.parse('{"HE":{"a4N":[],"awx":[]}}'))
var y={p:A.au("bn"),e:A.au("N"),b:A.au("@"),f:A.au("~")}};
(a=>{a["2dD1tHWjhdOLqAf2IURLI2ZexsY="]=a.current})($__dart_deferred_initializers__);