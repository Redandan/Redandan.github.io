...
w===$&&A.h()
return A.bP(x,D.aro,A.d4(C.aS,A.b([w,A.dH(0,A.h6(C.c9,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbMp(),x,x,x,x,x,x,!1,C.bR),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
...
coQ(d){var x=b.G.window.navigator.userAgent,w=$.dAG()
if(w.b.test(x)){$.aD.y2$.push(new B.cHX(this,d))
return C.xx}return new B.abC("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcXn(),null)},
cXo(){new B.cI1(this).$0()}}
...
x(A.W,[B.abC,B.Fi])
x(A.a0,[B.aUY,B.all])})()
A.fM(b.typeUniverse,JSON.parse('{"abC":{"W":[],"n":[]},"aUY":{"a0":["abC"]},"Fi":{"W":[],"n":[]},"all":{"a0":["Fi"]}}'))
...
x($,"ecd","dAG",()=>A.bs("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"edb","qY",()=>A.aU("SlotGamePage"))})()};
(a=>{a["Onsfbm9SEJpGAHXoFHS6Ab+ZVWM="]=a.current})($__dart_deferred_initializers__);