...
e6f(d){var x=b.G,w=A.eT(new B.d4s(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d4r(w)},
e6g(d){var x=b.G,w=A.eT(new B.d4u(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d4t(w)},
dfG(d){B.deG(A.bz(d),b.G.window.location.origin)},
deG(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
for(x=0;x<t.length;++x){w=t.item(x)
if(w!=null){v=A.iq(w,"HTMLIFrameElement")
v=!v}else v=!0
if(v)continue
u=w.src
if(C.b.aX(u,e))v=!A.oh(u,"/games/",0)
else v=!0
if(v)continue
v=w.contentWindow
...
u.e!==$&&A.be()
u.e=w
v=A.eT(new B.cJp(u.a.d))
u.f=v
w.addEventListener("load",v)
w.src=u.a.c
$.b00()
$.Cc().QA(x,new B.cJq(u),!0)},
aI(d){var x,w
this.b0(d)
x=this.a.c
if(d.c!==x){w=this.e
...
u(d){var x=this.d
x===$&&A.h()
return A.dbz(null,C.Et,x)}}
B.Fy.prototype={
T(){var x=$.az()
return new B.alV(x.$1$0(y.w),x.$1$0(y.r),x.$1$0(y.A))}}
B.alV.prototype={
a_(){var x,w=this
w.a6()
x=w.a.c
A.dsi().j(0,x)
x=w.cpr("moon_dance/index.html")
w.d!==$&&A.be()
w.d=x
w.Q=B.e6f(w.gbMO())
w.as=B.e6g(w.gcHb())
w.W3()
w.z=w.Xj()},
W3(){var x=0,w=A.m(y.H),v=1,u=[],t=this,s,r,q,p,o,n,m,l,k,j,i
var $async$W3=A.i(function(d,e){if(d===1){u.push(e)
x=v}for(;;)switch(x){case 0:v=3
x=6
return A.c(t.f.hP(),$async$W3)
case 6:s=e
if(t.c!=null&&s!=null){t.p(new B.cJu(t,s))
...
case 5:v=8
x=11
return A.c(t.e.eq(!0),$async$W3)
case 11:p=e
if(t.c!=null){l=p
k=l==null?null:l.f
o=k==null?0:k
t.p(new B.cJv(t,o))
try{b.G.window.localStorage.setItem("_flutter_game_balance",J.a1E(o,4))}catch(h){n=A.t(h)
$.r2().k(C.aC,"localStorage balance write failed",n,null)}}v=1
x=10
break
case 8:v=7
i=u.pop()
if(t.c!=null)t.p(new B.cJw(t))
x=10
break
case 7:x=1
break
...
return A.l($async$W3,w)},
xf(){return this.cmz()},
cmz(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
case 9:a1=a7
a0.a=a1
if(s.c!=null&&a1!=null)s.p(new B.cJr(a0,s))
u=2
x=8
break
case 6:u=5
...
j=h==null?null:h.f
a0.b=j==null?0:j
if(s.c!=null)s.p(new B.cJs(a0,s))
...
Wi(){var x=0,w=A.m(y.h),v,u=this,t,s
var $async$Wi=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:s=u.y
if(s!=null){v=s
x=1
break}t=u.z
if(t==null)t=u.z=u.Xj()
v=t.wd(C.MZ,new B.cJx())
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$Wi,w)},
Xj(){var x=0,w=A.m(y.h),v,u=2,t=[],s=[],r=this,q,p,o,n,m,l
var $async$Xj=A.i(function(d,e){if(d===1){t.push(e)
x=u}for(;;)switch(x){case 0:u=4
x=7
return A.c(r.r.aaS(r.a.c),$async$Xj)
case 7:q=e
...
Cy(d){return this.cHc(d)},
cHc(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
var $async$Cy=A.i(function(b6,b7){if(b6===1){t.push(b7)
...
break
case 7:n=s.c
if(n!=null)A.aX(n,!1).f.aQ(C.Ag,y.X)
v=null
x=1
break
case 8:n=s.c
if(n!=null)A.aX(n,!1).f.aQ(C.yh,y.X)
v=null
x=1
break
case 9:u=15
...
x=18
return A.c(s.r.U2(q,r,A.aW(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$Cy)
case 18:p=b7
o=J.aB(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.Sz(f,e),$async$Cy)
case 33:d=b7
...
w===$&&A.h()
return A.bQ(x,D.arK,A.d4(C.aT,A.b([w,A.dH(0,A.h7(C.ca,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbMO(),x,x,x,x,x,x,!1,C.bR),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
Wn(){var x=0,w=A.m(y.H),v,u=this
var $async$Wn=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:if(u.c==null){x=1
break}x=3
return A.c(u.apI(),$async$Wn)
case 3:case 1:return A.k(v,w)}})
return A.l($async$Wn,w)},
apI(){var x=0,w=A.m(y.H),v,u=this,t
var $async$apI=A.i(function(d,e){if(d===1)return A.j(e,w)
for(;;)switch(x){case 0:t=u.c
if(t==null){x=1
break}x=3
return A.c(A.a0(t,!1).zl(),$async$apI)
case 3:if(!e&&u.c!=null){t=u.c
t.toString
A.aX(t,!1).f.ii("/home",y.X)}case 1:return A.k(v,w)}})
return A.l($async$apI,w)},
cpr(d){var x=b.G.window.navigator.userAgent,w=$.dCV()
if(w.b.test(x)){$.aD.y2$.push(new B.cJt(this,d))
return C.xJ}return new B.ac8("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcYi(),null)},
cYj(){new B.cJy(this).$0()}}
var z=a.updateTypes(["ac<V<q,@>?>(V<q,@>)","ac<~>()","~()"])
B.d4s.prototype={
...
s=v.d
if(r){A.axu(t,"postMessage",u,s,y.X)
B.deG(u,s)}else{B.deG(u,s)
...
$S:16}
B.cJt.prototype={
$1(d){return this.c4q(d)},
c4q(a0){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d
...
l.window.localStorage.setItem("_flutter_game_balance",J.a1E(q,4))
l.window.localStorage.setItem("_flutter_game_api_base",g.r.amk())
l.window.localStorage.setItem("_flutter_game_id",g.a.c)
u=19
x=22
return A.c(g.Wi(),$async$$1)
case 22:u=4
x=21
break
case 19:u=18
...
u=y.H
x=3
return A.c(A.d_(D.aFO,null,u),$async$$0)
case 3:B.dfG(t)
x=4
return A.c(A.d_(D.aFw,null,u),$async$$0)
case 4:B.dfG(t)
return A.k(null,w)}})
return A.l($async$$0,w)},
$S:80};(function installTearOffs(){var x=a._instance_1u,w=a._instance_0u
var v
x(v=B.alV.prototype,"gcHb","Cy",0)
w(v,"gbMO","Wn",1)
w(v,"gcYi","cYj",2)})();(function inheritance(){var x=a.inheritMany
x(A.fe,[B.d4s,B.d4u,B.cJp,B.cJq,B.cJt])
x(A.h4,[B.d4r,B.d4v,B.d4t,B.cJu,B.cJv,B.cJw,B.cJr,B.cJs,B.cJx,B.cJy])
x(A.W,[B.ac8,B.Fy])
x(A.a_,[B.aVM,B.alV])})()
A.fP(b.typeUniverse,JSON.parse('{"ac8":{"W":[],"n":[]},"aVM":{"a_":["ac8"]},"Fy":{"W":[],"n":[]},"alV":{"a_":["Fy"]}}'))
var y=(function rtii(){var x=A.aw
return{u:x("ac<V<q,@>?>"),w:x("biH"),p:x("E<n>"),P:x("V<q,@>"),f:x("V<@,@>"),a:x("bm"),A:x("Na"),N:x("q"),r:x("NQ"),z:x("@"),h:x("V<q,@>?"),X:x("U?"),H:x("~")}})();(function constants(){D.arK=new A.Z(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
D.aFw=new A.bG(175e4)
D.aFO=new A.bG(75e4)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"eeF","dCV",()=>A.bs("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"efD","r2",()=>A.aU("SlotGamePage"))})()};
(a=>{a["A1Mw4+Hw+ssW/XdNT31qhBWPD9A="]=a.current})($__dart_deferred_initializers__);