...
eew(d){var w=b.G,v=A.f0(new B.daC(w.window.location.origin,d))
w.window.addEventListener("message",v)
return new B.daB(v)},
eex(d){var w=b.G,v=A.f0(new B.daE(w.window.location.origin,d))
w.window.addEventListener("message",v)
return new B.daD(v)},
dm0(d){B.dkZ(A.bB(d),b.G.window.location.origin)},
dkZ(d,e){var w,v,u,t,s=b.G.document.querySelectorAll("iframe")
...
t.e!==$&&A.b4()
t.e=v
u=A.f0(new B.cOB(t.a.d))
t.f=u
v.addEventListener("load",u)
v.src=t.a.c
$.b2k()
$.Cx().Zg(w,new B.cOC(t),!0)},
aM(d){var w,v
this.b1(d)
w=this.a.c
if(d.c!==w){v=this.e
...
u(d){var w=this.d
w===$&&A.h()
return A.dhO(null,C.Fm,w)}}
B.G4.prototype={
T(){var w=$.aA()
return new B.anE(w.$1$0(x.w),w.$1$0(x.r),w.$1$0(x.A),w.$1$0(x.G),w.$1$0(x.x))}}
B.anE.prototype={
a0(){var w,v=this
v.a6()
w=v.a.c
...
case 6:r=e
if(s.c!=null&&r!=null){s.p(new B.cOM(s,r))
...
n=j==null?0:j
s.p(new B.cON(s,n))
try{b.G.window.localStorage.setItem("_flutter_game_balance",J.a3q(n,4))}catch(g){m=A.u(g)
$.m2().k(C.aE,"localStorage balance write failed",m,null)}}u=1
w=10
break
case 8:u=7
h=t.pop()
if(s.c!=null)s.p(new B.cOO(s))
w=10
break
case 7:w=1
break
...
xH(){return this.csL()},
csL(){var w=0,v=A.m(x.P),u,t=2,s=[],r=this,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5
...
case 9:a2=a8
a1.a=a2
if(r.c!=null&&a2!=null)r.p(new B.cOE(a1,r))
t=2
w=8
break
case 6:t=5
...
i=g==null?null:g.f
a1.b=i==null?0:i
if(r.c!=null)r.p(new B.cOF(a1,r))
...
w=7
return A.c(q.w.b9W(q.a.c),$async$afK)
case 7:p=e
...
w=t}for(;;)switch(w){case 0:if(r.c!=null)r.p(new B.cOH(r))
t=4
w=7
return A.c(r.r.il(),$async$DF)
case 7:q=e
if(q==null||q.length===0){if(r.c==null){w=1
break}r.p(new B.cOI(r))
w=1
break}w=8
...
case 9:m=p
w=11
return A.c(r.bgD(m==null?null:m.w),$async$DF)
case 11:w=1
break
case 10:r.p(new B.cOJ(r,p))
t=2
w=6
break
case 4:t=3
...
if(r.c==null){w=1
break}r.p(new B.cOK(r,o))}else{n=m
$.m2().k(C.q,"getMyAccess failed",n,null)
if(r.c==null){w=1
break}r.p(new B.cOL(r))}w=6
break
case 3:w=2
break
...
bgD(d){return this.d7m(d)},
d7m(d){var w=0,v=A.m(x.H),u,t=2,s=[],r=this,q,p,o,n,m,l
var $async$bgD=A.i(function(e,f){if(e===1){s.push(f)
w=t}for(;;)switch(w){case 0:if(r.c==null){w=1
break}r.p(new B.cOR(r))
t=4
w=7
return A.c(r.y.D3(r.a.c,new A.a7R(r.cUd("game-session"),null,null)),$async$bgD)
case 7:q=f
if(r.c==null){w=1
break}n=q
if((n==null?null:n.e)!==C.Pr){r.p(new B.cOS(r,q))
w=1
break}r.p(new B.cOT(r,q,d))
t=2
w=6
break
case 4:t=3
...
if(r.c==null){w=1
break}r.p(new B.cOU(r,p))}else{o=n
$.m2().k(C.q,"start game session failed",o,null)
if(r.c==null){w=1
break}r.p(new B.cOV(r))}w=6
break
case 3:w=2
break
case 6:case 1:return A.k(u,v)
case 2:return A.j(s.at(-1),v)}})
return A.l($async$bgD,v)},
...
cUd(d){var w=Date.now(),v=C.d.mX($.b2a().Jc(0),16)
return d+"-"+this.a.c+"-"+1000*w+"-"+v},
bLn(d){switch(d){case"INSUFFICIENT_BALANCE":return y.a
case"REFUND_PENDING":return"The refund is still pending. Refresh after it completes."
case null:case void 0:case"":return null
default:return d}},
d4x(d){var w,v=null,u=d==null
if((u?v:d.e)===C.Ps){w=this.bLn(u?v:d.f)
...
E_(d){return this.cNE(d)},
cNE(b6){var w=0,v=A.m(x.h),u,t=2,s=[],r=this,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5
...
if(!r)C.f.C(s,A.b([u,A.dM(0,A.h_(C.c8,v,C.z,!1,v,v,v,v,v,v,v,v,v,v,v,v,v,v,v,v,v,v,v,w.gbtT(),v,v,v,v,v,v,!1,C.bU),108,v,0,v,v,75)],t))
else s.push(w.cr1(d))
if(r)s.push(new A.dO(!0,!0,!0,!0,C.J,!1,new A.ce(C.ie,v,v,A.aM(v,v,v,v,v,D.aRN,v,v,w.gbtT(),v,v,v,v,"Back",v),v),v))
return A.bO(v,D.au9,A.d1(C.aT,s,C.t,C.aQ,v),v,v,v,v,v)},
cr1(d){var w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=A.p(d),j=m.ax,i=j==null
if((i?l:j.f)==null)w=l
else{v=j.f
u=j.d
if(u==null)u=""
...
if(!o||t!=null){o=o?"-":w
n=t==null?"-":t
C.f.C(r,A.b([C.Ht,new B.ag1("Wallet",o,l),new B.ag1("Required",n,l)],p))}o=m.db
if(o!=null)C.f.C(r,A.b([C.Ht,A.d(o,l,l,l,l,l,q?l:u.a1(D.asP),C.aO,l,l)],p))
r.push(D.bHW)
u=!m.ch
if(!u||m.CW)q=l
else if(m.cy)q=new B.cOD(d)
else q=m.gbO_()
r.push(A.cq(!u||m.CW?A.w(A.b([C.p6,C.iV,A.d(s,l,l,l,l,l,l,l,l,l)],p),C.l,l,C.b_,C.I,0,l,l):A.d(s,l,l,l,l,l,l,l,l,l),l,q,l))
r.push(C.ee)
r.push(A.aI(D.bUK,l,l,l,m.ch||m.CW?l:m.gbO_(),l,l))
return A.aK(new A.ba(C.KQ,new A.G(C.b2,new A.c7(new A.L(D.as1,l,v,i,l,l,C.r),C.au,new A.G(C.b2,A.v(r,C.an,l,C.e,C.I,0,C.k),l),l),l),l),l,l,l)},
...
cvI(d,e){var w=b.G.window.navigator.userAgent,v=$.dKd()
if(v.b.test(w)){$.aG.y2$.push(new B.cOG(this,d,e))
return C.ym}return new B.adH(this.bRe(d,e,Date.now()),this.gd4o(),null)},
bRe(d,e,f){var w=e!=null&&C.b.aS(e,"/")?e:"/games/"+d
return w+(C.b.t(w,"?")?"&":"?")+"flutter=1&_ts="+f},
d4p(){new B.cOQ(this).$0()}}
B.ag1.prototype={
...
r=u.d
if(q){A.azg(s,"postMessage",t,r,x.X)
B.dkZ(t,r)}else{B.dkZ(t,r)
...
v=w.a===401
u.cy=v
u.db=v?"Sign in to play this game.":u.bM8(w)},
$S:0}
B.cOL.prototype={
$0(){var w=this.a
w.ch=!1
...
w.ay=this.b
w.d===$&&A.h()
w.e=w.cvI("moon_dance/index.html",this.c)
w.ch=!1},
$S:0}
B.cOU.prototype={
$0(){var w,v,u=this.a
...
cad(a0){var w=0,v=A.m(x.H),u,t=2,s=[],r=this,q,p,o,n,m,l,k,j,i,h,g,f,e,d
...
k.window.localStorage.setItem("_flutter_game_balance",J.a3q(p,4))
k.window.localStorage.setItem("_flutter_game_api_base",g.w.bbk())
...
case 23:g=g.bRe(r.b,r.c,Date.now())
...
t=x.H
w=3
return A.c(A.de(D.aJm,null,t),$async$$0)
case 3:B.dm0(s)
w=4
return A.c(A.de(D.aJ4,null,t),$async$$0)
case 4:B.dm0(s)
return A.k(null,v)}})
return A.l($async$$0,v)},
$S:95};(function installTearOffs(){var w=a._instance_0u,v=a._instance_1u
var u
w(u=B.anE.prototype,"gbO_","DF",0)
v(u,"gcND","E_",1)
w(u,"gbtT","aeL",0)
w(u,"gd4o","d4p",2)})();(function inheritance(){var w=a.inheritMany,v=a.inherit
w(A.fi,[B.daC,B.daE,B.cOB,B.cOC,B.cOG])
w(A.h8,[B.daB,B.daF,B.daD,B.cOM,B.cON,B.cOO,B.cOE,B.cOF,B.cOP,B.cOH,B.cOI,B.cOJ,B.cOK,B.cOL,B.cOR,B.cOS,B.cOT,B.cOU,B.cOV,B.cOD,B.cOQ])
w(A.W,[B.adH,B.G4])
w(A.Z,[B.aY2,B.anE])
v(B.ag1,A.x)})()
A.fT(b.typeUniverse,JSON.parse('{"adH":{"W":[],"n":[]},"aY2":{"Z":["adH"]},"G4":{"W":[],"n":[]},"anE":{"Z":["G4"]},"ag1":{"x":[],"n":[]}}'))
var y={a:"Your wallet balance is not enough for the refundable access check."}
var x=(function rtii(){var w=A.au
return{u:w("aa<U<q,@>?>"),G:w("Kg"),w:w("bly"),p:w("E<n>"),P:w("U<q,@>"),f:w("U<@,@>"),a:w("bo"),A:w("O2"),N:w("q"),x:w("OB"),r:w("Gm"),z:w("@"),h:w("U<q,@>?"),X:w("V?"),H:w("~")}})();(function constants(){D.as1=new A.Y(1,0.08235294117647059,0.08235294117647059,0.15294117647058825,C.A)
D.asP=new A.Y(1,1,0.7686274509803922,0.7686274509803922,C.A)
D.au9=new A.Y(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.A)
D.aJ4=new A.bJ(175e4)
D.aJm=new A.bJ(75e4)
D.aRN=new A.aq(C.jq,null,C.E,null,null)
D.bHW=new A.ad(null,22,null,null)
D.bKu=new A.xF(null,!1)
D.bUK=new A.bf("Refresh access",null,null,null,null,null,null,null,null,null,null)})();(function lazyInitializers(){var w=a.lazyFinal
w($,"enb","dKd",()=>A.bn("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
w($,"eo9","m2",()=>A.aY("SlotGamePage"))})()};
(a=>{a["eCx1nXTfC46p63m1TRt/0xrIIG8="]=a.current})($__dart_deferred_initializers__);