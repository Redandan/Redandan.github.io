import{i as O,c as R,a as I,x as l,r as T,C,J as h,m as j,K as A,R as W,O as z,n as E,l as F,W as P,L as U}from"./wallet-vendor.CrHgAq_T.js";import{n as c,o as B,r as v}from"./if-defined.DyvJsjgC.js";import"./index.CXvwSUiE.js";import"./index.arZ8f-gU.js";import"./index.BN9Lgz1n.js";import"./index.DMRapoN4.js";import"./index.BToerQhK.js";var L;(function(r){r.approve="approved",r.bought="bought",r.borrow="borrowed",r.burn="burnt",r.cancel="canceled",r.claim="claimed",r.deploy="deployed",r.deposit="deposited",r.execute="executed",r.mint="minted",r.receive="received",r.repay="repaid",r.send="sent",r.sell="sold",r.stake="staked",r.trade="swapped",r.unstake="unstaked",r.withdraw="withdrawn"})(L||(L={}));const V=O`
  :host > wui-flex {
    display: flex;
