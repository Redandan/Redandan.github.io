import{i as f,c as w,a as m,m as I,C as x,v as H,aa as l,x as u,r as z,e as W,R as g,N as L,U as $,a1 as q,A as F,S as _,n as M,l as Y,W as K}from"./wallet-vendor.CHv2NQr2.js";import{n as d,r as c,o as G}from"./if-defined.Cm0iLOsI.js";import"./index.av5FkuPM.js";import"./index.zc6-bE5x.js";import{e as O,n as D}from"./ref.B3da7r69.js";import"./index.DNPD4e61.js";import{n as J,s as Q}from"./ConstantsUtil.Dmg8YACJ.js";import"./index.D94szjeW.js";import"./index.B9WsiF1T.js";import"./index.DpWtL72Z.js";import"./index.Drn3zD0v.js";import"./index.BCDYqGT4.js";import"./index.B0xO4txX.js";import"./react-vendor.Bj0G0Oyz.js";import"./buffer-polyfill.ErO7y5re.js";import"./index.BcWcgPLm.js";import"./index.D9uRDNEr.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var S=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let b=class extends m{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search="",this.onDebouncedSearch=I.debounce(e=>{this.search=e}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(e=>{this.tokenBalances=e.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u`
    ...
    `}onBuyClick(){g.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){l.setToken(e),l.setTokenAmount(void 0),g.goBack()}};b.styles=ie;S([c()],b.prototype,"tokenBalances",void 0);S([c()],b.prototype,"tokens",void 0);S([c()],b.prototype,"filteredTokens",void 0);S([c()],b.prototype,"search",void 0);b=S([w("w3m-wallet-send-select-token-view")],b);const ne=f`
  :host {
    display: flex;
