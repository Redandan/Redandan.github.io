...
e3V(d){var x=b.G,w=A.eS(new B.d2C(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d2B(w)},
e3W(d){var x=b.G,w=A.eS(new B.d2E(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.d2D(w)},
ddQ(d){B.dcQ(A.bz(d),b.G.window.location.origin)},
dcQ(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
...
u.e!==$&&A.bj()
u.e=w
v=A.eS(new B.cHV(u.a.d))
u.f=v
w.addEventListener("load",v)
w.src=u.a.c
$.b_b()
$.C1().Qr(x,new B.cHW(u),!0)},
aI(d){var x,w
this.b0(d)
x=this.a.c
if(d.c!==x){w=this.e
...
u(d){var x=this.d
x===$&&A.h()
return A.d9J(null,C.Ei,x)}}
B.Fi.prototype={
S(){var x=$.az()
return new B.aln(x.$1$0(y.w),x.$1$0(y.r),x.$1$0(y.A))}}
B.aln.prototype={
a_(){var x,w=this
w.a6()
x=w.a.c
A.dqb().j(0,x)
x=w.coQ("moon_dance/index.html")
w.d!==$&&A.bj()
w.d=x
w.Q=B.e3V(w.gbMr())
w.as=B.e3W(w.gcGo())
...
case 6:s=e
if(t.c!=null&&s!=null){t.p(new B.cI_(t,s))
try{b.G.window.localStorage.setItem("_flutter_game_jwt",s)}catch(h){r=A.t(h)
$.qY().k(C.ay,"localStorage jwt write failed (private mode?)",r,null)}}v=1
x=5
break
case 3:v=2
j=u.pop()
...
$.qY().k(C.ay,"localStorage balance write failed",n,null)}}v=1
x=10
break
case 8:v=7
i=u.pop()
if(t.c!=null)t.p(new B.cI1(t))
x=10
break
case 7:x=1
break
...
xf(){return this.cm3()},
cm3(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
case 9:a1=a7
a0.a=a1
if(s.c!=null&&a1!=null)s.p(new B.cHX(a0,s))
u=2
x=8
break
case 6:u=5
...
$.qY().k(C.ay,"localStorage jwt write failed in shim",p,null)}x=s.w==null?10:12
break
case 10:u=14
x=17
...
j=h==null?null:h.f
a0.b=j==null?0:j
if(s.c!=null)s.p(new B.cHY(a0,s))
try{b.G.window.localStorage.setItem("_flutter_game_balance",C.j.Y(a0.b,4))}catch(a5){n=A.t(a5)
$.qY().k(C.ay,"localStorage balance write failed in shim",n,null)}u=2
x=16
break
case 14:u=13
a3=t.pop()
...
x=7
return A.c(r.r.aaH(r.a.c),$async$X9)
case 7:q=e
...
$.qY().k(C.ay,"localStorage rtp write failed",o,null)}v=p
s=[1]
x=5
break}s.push(6)
x=5
...
cGp(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
...
x=18
return A.c(s.r.TU(q,r,A.aW(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$Cx)
case 18:p=b7
o=J.aB(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.Sq(f,e),$async$Cx)
case 33:d=b7
...
w===$&&A.h()
return A.bP(x,D.aro,A.d4(C.aS,A.b([w,A.dH(0,A.h6(C.c9,x,C.z,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.gbMr(),x,x,x,x,x,x,!1,C.bR),108,x,0,x,x,75)],y.p),C.t,C.aP,x),x,x,x,x,x)},
...
coQ(d){var x=b.G.window.navigator.userAgent,w=$.dAM()
if(w.b.test(x)){$.aD.y2$.push(new B.cHZ(this,d))
return C.xx}return new B.abD("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcXn(),null)},
cXo(){new B.cI3(this).$0()}}
...
s=v.d
if(r){A.awR(t,"postMessage",u,s,y.X)
B.dcQ(u,s)}else{B.dcQ(u,s)
...
e=t.pop()
n=A.t(e)
$.qY().k(C.ay,"RTP prefetch failed",n,null)
x=21
break
case 18:x=4
break
...
var v
x(v=B.aln.prototype,"gcGo","Cx",0)
w(v,"gbMr","Wd",1)
w(v,"gcXn","cXo",2)})();(function inheritance(){var x=a.inheritMany
x(A.fd,[B.d2C,B.d2E,B.cHV,B.cHW,B.cHZ])
x(A.h3,[B.d2B,B.d2F,B.d2D,B.cI_,B.cI0,B.cI1,B.cHX,B.cHY,B.cI2,B.cI3])
x(A.W,[B.abD,B.Fi])
x(A.a0,[B.aV_,B.aln])})()
A.fM(b.typeUniverse,JSON.parse('{"abD":{"W":[],"n":[]},"aV_":{"a0":["abD"]},"Fi":{"W":[],"n":[]},"aln":{"a0":["Fi"]}}'))
var y=(function rtii(){var x=A.aw
return{u:x("ad<V<q,@>?>"),w:x("bhL"),p:x("E<n>"),P:x("V<q,@>"),f:x("V<@,@>"),a:x("bl"),A:x("MR"),N:x("q"),r:x("Nv"),z:x("@"),h:x("V<q,@>?"),X:x("U?"),H:x("~")}})();(function constants(){D.aro=new A.Y(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
D.aEx=new A.bF(175e4)
D.aEP=new A.bF(75e4)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"eck","dAM",()=>A.bs("Mobi|Android|iPhone|iPad|iPod",!1,!1,!1,!1))
x($,"edi","qY",()=>A.aU("SlotGamePage"))})()};
(a=>{a["tN/MyvsECTzGcJ4dPRDw3h7rFwU="]=a.current})($__dart_deferred_initializers__);