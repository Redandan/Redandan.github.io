...
return C.y3}return new B.acW("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gd0g(),null)},
d0h(){new B.cLU(this).$0()}}
...
var v
x(v=B.amN.prototype,"gcJO","CL",0)
w(v,"gbP8","WR",1)
w(v,"gd0g","d0h",2)})();(function inheritance(){var x=a.inheritMany
...
return{u:x("ab<U<q,@>?>"),w:x("bjQ"),p:x("E<n>"),P:x("U<q,@>"),f:x("U<@,@>"),a:x("bn"),A:x("Ny"),N:x("q"),r:x("Od"),z:x("@"),h:x("U<q,@>?"),X:x("W?"),H:x("~")}})();(function constants(){D.at2=new A.Y(1,0.0196078431372549,0.00784313725490196,0.09411764705882353,C.y)
...
(a=>{a["s2K6lX+YKXf/tLrC+jca/5thmDs="]=a.current})($__dart_deferred_initializers__);