...
return null},
dmT(d,e,f){var x=e==null?null:C.b.G(e),w=x==null||x.length===0?"current":x
...
_.f=i
_.r=j},
eg6(d){var x=b.G,w=A.f0(new B.dbP(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.dbO(w)},
eg7(d){var x=b.G,w=A.f0(new B.dbR(x.window.location.origin,d))
x.window.addEventListener("message",w)
return new B.dbQ(w)},
dnh(d){B.dmd(A.bB(d),b.G.window.location.origin)},
dmd(d,e){var x,w,v,u,t=b.G.document.querySelectorAll("iframe")
...
this.b=e},
dbS:function dbS(d,e,f,g){var _=this
_.a=d
_.b=e
_.c=f
_.d=g},
...
dAt(d,e){return new B.Gd(d,e,null)},
...
if(w)return null
return x.c9q("telegram.me")},
dcd(d,e){var x=d.c?d:A.drB(A.bz(d),A.bC(d),A.c1(d),A.hA(d),A.n2(d),A.Mk(d),A.aD9(d),d.b)
return x.fe(e.a)},
efw(d,e){var x=d.U(),w=B.dcd(e,C.aS)
if(B.dn1(w,x))return C.aS
return B.dn1(w.fe(288e8),x)?D.aJI:C.aS},
dn1(d,e){return Math.abs(d.U().bS(e.U()).a)<=3e8},
e27(d){var x
...
xP(){return this.ctE()},
ctE(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
lG(d,e){return this.d8i(d,!0)},
d8h(d){return this.lG(!0,d)},
d8i(c0,c1){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8,b9
...
i=m==null?null:B.dcd(m.f,j)
h=m==null?null:B.dcd(m.r,j)
g=m==null?null:B.dcd(m.x,j)
b3=m
...
uQ(d){return this.cE_(!0)},
cE_(d){var x=0,w=A.m(y.y),v,u=2,t=[],s=[],r=this,q,p,o,n,m,l,k
...
E4(d,e,f){return this.cE6(d,!0,f)},
cE6(d,e,f){var x=0,w=A.m(y.y),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k
...
bbY(d){var x=A.duY(d),w=x==null?null:C.b.G(x)
...
return B.dmT(D.PG,this.cy,"product-"+x)},
gbUR(){var x=this.d
x=x==null?null:x.a
if(x==null)x=this.a.c
if(x==null)x="unknown"
return B.dmT(D.PG,this.cy,x)},
gbZm(){var x=this.d
x=x==null?null:x.a
if(x==null)x=this.a.c
if(x==null)x="unknown"
return B.dmT(D.aNM,this.cy,x)},
...
return e},
cUp(d,e){switch(e){case D.iz:return d.gaa9()
...
Ec(d){return this.cOB(d)},
cOB(b6){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5
...
crU(a1){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e=this,d=null,a0=A.f(a1,C.c,y.J)
a0.toString
x=e.d
w=e.ay
v=e.e
...
return C.yw}return new B.adX(w.bRY(t,Date.now()),w.gd5k(),null)},
bRY(d,e){var x="/games/"+d
return x+(C.b.t(x,"?")?"&":"?")+"flutter=1&_ts="+e},
d5l(){new B.cPW(this).$0()}}
B.ayf.prototype={
u(d){var x=A.f(d,C.c,y.J)
x.toString
return new A.dG(!0,!0,!0,!0,C.J,!1,A.d1(new B.bjL(this,x,A.p(d),this.cG_(x))),null)},
cG_(d){switch(this.d.gmX().a){case 1:return d.gDc()
case 2:return d.gXn()
...
x.d=new A.xI(w.b,w.gdmQ(),"Telegram Mini App",null,C.i7,4279724935,"\ud83c\udfae",null,!1)
x.fx=!0
x.id=null},
$S:0}
B.cPE.prototype={
...
$S:37}
B.cPc.prototype={
$0(){return this.a.cNs(this.b.gmX())},
$S:0}
B.cPd.prototype={
$0(){this.a.bwG()
return null},
...
cb2(d){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e
...
var v
x(v=B.anU.prototype,"gcOA","Ec",0)
w(v,"gbuy","afq",1)
w(v,"gd5k","d5l",2)})();(function inheritance(){var x=a.inheritMany,w=a.inherit
x(A.nl,[B.nT,B.zO,B.aye])
w(B.bjK,A.V)
x(A.fi,[B.dbP,B.dbR,B.cPa,B.cPb,B.cPg])
x(A.h8,[B.dbO,B.dbS,B.dbQ,B.cPu,B.cPv,B.cPw,B.cPe,B.cPf,B.cPx,B.cPC,B.cPD,B.cPE,B.cPF,B.cPh,B.cPi,B.cPj,B.cPk,B.cPl,B.cPm,B.cPn,B.cPo,B.cPp,B.cPq,B.cPr,B.cPN,B.cPO,B.cPP,B.cPQ,B.cPR,B.cPS,B.cPT,B.cPU,B.cPV,B.cPX,B.cPY,B.cPZ,B.cQ_,B.cQ0,B.cQ1,B.cQ2,B.cQ3,B.cQ4,B.cPG,B.cPH,B.cPI,B.cPJ,B.cPK,B.cPL,B.cPM,B.cPy,B.cPA,B.cPc,B.cPd,B.cPW])
x(A.W,[B.adX,B.Gd])
x(A.a_,[B.aYq,B.anU])
...
(a=>{a["DqWWpwlNQ8O+9EjBad9HrPXQYA0="]=a.current})($__dart_deferred_initializers__);