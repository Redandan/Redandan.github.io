...
dUS(d,e){var x=new B.FR(e,d,A.aU("WebRTCManager"))
x.bNK()
return x},
...
B.FR.prototype={
OG(d){return this.dhJ(d)},
dhJ(d){var x=0,w=A.m(y.e),v,u=this
var $async$OG=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yC(new B.bPf(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$OG)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$OG,w)},
bNK(){var x=this,w=x.a
x.y=w.gd85().e4(new B.bP5(x),new B.bP6(x))
x.z=w.gdnN().e4(new B.bP7(x),new B.bP8(x))
x.Q=w.gdhB().e4(new B.bP9(x),new B.bPa(x))
x.as=w.gcaL().e4(new B.bPb(x),new B.bPc(x))},
U0(d){return this.caT(d)},
caT(d){var x=0,w=A.m(y.e),v,u=this
var $async$U0=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.yC(new B.bPg(u,d),"startAudioCall","Failed to start audio call",y.e),$async$U0)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
return A.l($async$U0,w)},
q9(d){return this.d6N(d)},
d6N(d){var x=0,w=A.m(y.e),v,u=this,t
var $async$q9=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:t=d?"Failed to answer call":"Failed to reject call"
x=3
return A.c(D.yC(new B.bPd(u,d),"answerCall",t,y.e),$async$q9)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.yC(new B.bPe(v),"endCall","Failed to end call",y.p),$async$t_)
case 2:return A.k(null,w)}})
return A.l($async$t_,w)},
bBv(){return D.dgP(new B.bPh(this),"toggleAudio","Failed to switch audio")},
c9A(d){this.e=d},
c9y(d){this.f=d},
c9z(d){var x=null,w=this.c
...
c9x(d){this.w=d},
gbyg(){return this.d},
ga3W(){return this.a.ga3W()},
ga40(){return this.a.ga40()},
ga1m(){return this.a.ga1m()},
aq6(){var x=0,w=A.m(y.f),v=this,u,t
var $async$aq6=A.i(function(d,e){if(d===1)return A.j(e,w)
...
x=5
return A.c(s.aq6(),$async$$0)
case 5:case 4:s.a.bDJ(q)
...
q=q.a
t.k(C.d,"\ud83d\udcca [WebRTC Manager] Call state: isCallActive="+q.ga3W(),null,null)
x=3
...
return!1}return x.a.bBv()},
$S:34};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.FR,A.U)
w(A.h3,[B.bPf,B.bPg,B.bPd,B.bPe,B.bPh])
w(A.fd,[B.bP5,B.bP6,B.bP7,B.bP8,B.bP9,B.bPa,B.bPb,B.bPc])})()
A.fM(b.typeUniverse,JSON.parse('{"FR":{"a4r":[],"awy":[]}}'))
var y={p:A.aw("bl"),e:A.aw("I"),b:A.aw("@"),f:A.aw("~")}};
(a=>{a["VopDRMIdaTfulfaaCT3uzTj+HSc="]=a.current})($__dart_deferred_initializers__);