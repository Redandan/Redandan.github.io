...
return A.c(D.z8(new B.bV9(u,d),"initialize","Failed to initialize WebRTC manager",y.e),$async$WZ)
case 3:v=f
x=1
break
...
x.y=w.gdix().ee(new B.bV_(x),new B.bV0(x))
x.z=w.gdyQ().ee(new B.bV1(x),new B.bV2(x))
x.Q=w.gdsi().ee(new B.bV3(x),new B.bV4(x))
x.as=w.gciX().ee(new B.bV5(x),new B.bV6(x))},
abg(d){return this.cj4(d)},
cj4(d){var x=0,w=A.m(y.e),v,u=this
var $async$abg=A.i(function(e,f){if(e===1)return A.j(f,w)
for(;;)switch(x){case 0:x=3
return A.c(D.z8(new B.bVa(u,d),"startAudioCall","Failed to start audio call",y.e),$async$abg)
case 3:v=f
x=1
break
case 1:return A.k(v,w)}})
...
return A.c(D.z8(new B.bV8(v),"endCall","Failed to end call",y.p),$async$tu)
case 2:return A.k(null,w)}})
return A.l($async$tu,w)},
bIH(){return D.ds1(new B.bVb(this),"toggleAudio","Failed to switch audio")},
chL(d){this.e=d},
chJ(d){this.f=d},
...
(a=>{a["k0AhEnm9kNkw7Y87+hzk33jod0s="]=a.current})($__dart_deferred_initializers__);