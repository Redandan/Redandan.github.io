...
xe(){return this.cm2()},
cm2(){var x=0,w=A.m(y.P),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4
...
Cx(d){return this.cGo(d)},
cGo(b5){var x=0,w=A.m(y.h),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4
...
x=18
return A.c(s.r.TS(q,r,A.aW(b5.j(0,"clientRoundId")),a3,a9,a2,a4),$async$Cx)
case 18:p=b7
o=J.aB(p,"data")
...
e=a8==null?10:a8
x=33
return A.c(s.r.So(f,e),$async$Cx)
case 33:d=b7
...
if(t==null){x=1
break}x=3
return A.c(A.a_(t,!1).zk(),$async$aps)
case 3:if(!e&&u.c!=null){t=u.c
t.toString
A.aX(t,!1).f.ii("/home",y.X)}case 1:return A.k(v,w)}})
return A.l($async$aps,w)},
coP(d){var x=b.G.window.navigator.userAgent,w=$.dAJ()
if(w.b.test(x)){$.aD.y2$.push(new B.cHX(this,d))
return C.xy}return new B.abC("/games/"+d+"?flutter=1&_ts="+Date.now(),this.gcXl(),null)},
cXm(){new B.cI1(this).$0()}}
...
c3Y(a0){var x=0,w=A.m(y.H),v,u=2,t=[],s=this,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d
...
var v
x(v=B.all.prototype,"gcGn","Cx",0)
w(v,"gbMo","Wb",1)
w(v,"gcXl","cXm",2)})();(function inheritance(){var x=a.inheritMany
...
(a=>{a["jWSLachajhGaP1W34uKTU/yb5gM="]=a.current})($__dart_deferred_initializers__);